...
9. **Kapanış — marka adı CTA'sı YASAK (2026-09-23'te Koray'ın geri bildirimiyle düzeltildi):** Önceki kural her hizmet yazısı kaynaklı taslağı "...Koray Akdağ / Sistem Global Danışmanlık ekibinin ... hizmetlerinden biri" / "...bu süreci uçtan uca yürütüyor" gibi neredeyse birebir aynı kalıpla bitiriyordu; Koray bunun reklam gibi durduğunu, yazıların böyle bitmemesi gerektiğini belirtti (12 bekleyen taslak 2026-09-23'te bu kalıp temizlenerek düzeltildi). Artık: **son cümlede "Koray Akdağ" veya "Sistem Global" adını kesinlikle geçirme.** Bunun yerine yazı, doğal bir gözlem/soru/hot-take ile bitsin — çoğu zaman en güçlü kapanış, konuyu anlatan son somut cümlenin kendisidir, ayrıca bir "bu işi biz yaparız" cümlesine gerek yok. Örnek referans: `research/linkedin-taslaklar/2026-09-08-doviz-donusum-destegi-1-ekim.json`, `2026-09-06-ortaklik-ayriliginda-sirket-degeri.json`. Marka adı hiç geçmeyince tekdüzelik riski de azalır — her taslakta farklı bir kapanış biçimi (soru, gözlem, ima) kullan.
