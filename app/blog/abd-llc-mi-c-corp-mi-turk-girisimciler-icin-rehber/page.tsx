  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Sonradan LLC'den C-Corp'a geçebilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Teknik olarak mümkündür. Uygulamada statutory conversion, birleşme yoluyla dönüşüm veya Form 8832 ile vergisel sınıflandırma değişikliği gibi yollar kullanılır. Ancak dönüşüm hem hukuki hem vergisel sonuçlar doğurur, mevcut sözleşmelerin ve banka hesaplarının yenilenmesini gerektirir ve yatırım turu baskısı altında yapıldığında maliyeti artar. Yatırım alma ihtimali ciddi ise baştan C-Corp kurmak genellikle daha ekonomiktir."}},{"@type":"Question","name":"Türkiye'deki limited şirketim ABD'deki şirkete ortak olabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Bu yapı, temettü stopajında ÇVÖA'nın %15'lik indirimli oranından yararlanma imkânı da sunabilir, çünkü bu oran oy hakkının en az %10'una sahip şirket ortakları için öngörülmüştür. Buna karşılık kontrol edilen yabancı kurum kuralları ve transfer fiyatlandırması yükümlülükleri daha belirgin hale gelir. Karar, gerçek kişi ortaklık ile karşılaştırmalı olarak verilmelidir."}},{"@type":"Question","name":"2026'da BOI bildirimi yapmam gerekiyor mu?","acceptedAnswer":{"@type":"Answer","text":"Delaware, Wyoming ya da başka bir ABD eyaletinde kurulmuş bir şirketiniz varsa hayır. 11 Ağustos 2026 tarihli nihai kural, ABD'de kurulmuş şirketleri BOI bildiriminden kalıcı olarak muaf tuttu. Yükümlülük yalnızca yabancı ülke hukukuna göre kurulup bir ABD eyaletinde faaliyet için kayıt yaptıran şirketler açısından devam ediyor."}},{"@type":"Question","name":"Wyoming'de kurup Kaliforniya'dan müşteri kabul edersem sorun olur mu?","acceptedAnswer":{"@type":"Answer","text":"Sadece o eyaletten müşteri kabul etmek tek başına genellikle kayıt zorunluluğu doğurmaz. Sorun, o eyalette fiziksel varlık oluşturduğunuzda başlar: ofis, çalışan, depo veya sürekli ve düzenli ticari faaliyet gibi. Satış vergisi tarafında ise tamamen ayrı bir eşik sistemi işler ve fiziksel varlık olmasa dahi hacim eşiği aşıldığında yükümlülük doğar."}},{"@type":"Question","name":"Hangi eyalet gerçekten en ucuz?","acceptedAnswer":{"@type":"Answer","text":"Yalnızca eyalet ücretlerine bakıldığında Wyoming, yıllık 60 USD'lik asgari lisans vergisiyle listenin en altındadır. Ancak toplam maliyet, registered agent ücreti, muhasebe ve beyan hizmetleri ile varsa ikinci eyalet kayıtlarını da içerir. Yanlış eyalette kurulmuş bir şirketin ilerideki düzeltme maliyeti, başlangıçta ödenen birkaç yüz dolarlık farkın çok üzerindedir."}},{"@type":"Question","name":"ABD'de şirket kurmak bana vize veya oturum hakkı sağlar mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Şirket sahibi olmak, ABD'de çalışma veya ikamet hakkı vermez. Göçmenlik statüsü tamamen ayrı bir süreçtir ve şirket kuruluşuyla otomatik bir bağlantısı bulunmaz. Bu iki konunun karıştırılması, yanlış beklentiye yol açan yaygın bir durumdur."}}]}) }}
      />
    </BlogLayout>
  );
}
