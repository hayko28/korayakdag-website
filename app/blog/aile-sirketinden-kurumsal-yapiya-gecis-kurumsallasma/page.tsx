  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Kurumsallaşma yalnızca büyük şirketler için mi gereklidir?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kurumsallaşma ihtiyacı genellikle şirket belirli bir ölçeğe (çalışan sayısı, ciro, şube/lokasyon sayısı) ulaşıp kurucunun her karara tek başına yetişemediği noktada ortaya çıkar. Orta ölçekli bir KOBİ, süreci küçük ve yönetilebilir adımlarla başlatabilir; büyük bir bütçe veya karmaşık bir danışmanlık projesi şart değildir."}},{"@type":"Question","name":"Kurumsallaşma, kurucunun şirket üzerindeki söz hakkını azaltır mı?","acceptedAnswer":{"@type":"Answer","text":"Doğru kurgulandığında hayır; kurucunun rolü azalmaz, netleşir. Kurucu genellikle yönetim kurulu düzeyinde stratejik yönü belirlemeye devam eder; günlük operasyonel yükü ise icra kuruluna/profesyonel yöneticilere devrederek asıl katma değerini stratejik konulara ayırabilir."}},{"@type":"Question","name":"Aile anayasası hukuken bağlayıcı mıdır?","acceptedAnswer":{"@type":"Answer","text":"Türk hukukunda aile anayasasının doğrudan bir yasal bağlayıcılığı bulunmaz; ancak atipik bir sözleşme niteliği taşır ve aile üyelerinin gönüllü uyumuna dayanır. Bağlayıcılık güçlendirilmek isteniyorsa, ortaklık sözleşmesi veya şirket ana sözleşmesi gibi hukuken bağlayıcı belgelerle desteklenmesi önerilir; bu konuda somut hukuki yapı için uzman görüşü alınmalıdır."}},{"@type":"Question","name":"Kurumsallaşma süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Şirketin ölçeğine, mevcut yapının olgunluğuna ve organizasyonun değişime açıklığına göre değişir. Temel yönetişim ve süreç unsurlarının kurulması genellikle aylar süren bir çalışmadır; yapının şirket kültürüne tam olarak yerleşmesi ise yıllara yayılabilir."}},{"@type":"Question","name":"Yönetim kurulu ile icra kurulu aynı kişilerden oluşabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Küçük ölçekli şirketlerde başlangıçta bazı kişiler her iki organda da yer alabilir; önemli olan kişilerin çakışması değil, hangi konunun hangi \"şapka\" ile, hangi gündem ve toplantı disipliniyle görüşüldüğünün net olmasıdır. Şirket büyüdükçe bu iki organın giderek ayrışması hedeflenmelidir."}}]}) }}
      />
    </BlogLayout>
  );
}
