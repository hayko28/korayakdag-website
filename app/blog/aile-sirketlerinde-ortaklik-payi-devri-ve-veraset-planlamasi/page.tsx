  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Şirket ortağı vefat ederse hisseleri otomatik olarak kime geçer?","acceptedAnswer":{"@type":"Answer","text":"Yasal mirasçılara, ayrı bir işlem veya beyana gerek kalmadan halefiyet ilkesi gereği doğrudan geçer. Mirasçılar birden fazlaysa, hisse kendi aralarındaki miras oranına göre bölünür ve her biri otomatik olarak ortak sıfatını kazanır."}},{"@type":"Question","name":"Vasiyetname ile bütün hisseleri tek bir çocuğa bırakabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Ancak tasarruf edilebilir kısım sınırları içinde kalırsanız. Diğer çocuklarınızın ve eşinizin saklı payı kanunla korunduğu için, bu payı ihlal eden bir vasiyetname, ilgili mirasçı dava açarsa tenkis yoluyla kısmen geçersiz kılınabilir."}},{"@type":"Question","name":"Şirket, istemediği bir mirasçıyı ortaklığa almak zorunda mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır, ancak koşullu olarak. Limited şirkette TTK m.596, anonim şirkette (esas sözleşmede devir kısıtlaması varsa) TTK m.494 uyarınca şirket, mirasçının payı iktisap etmesinden itibaren 3 ay içinde, payı gerçek değeri üzerinden satın almayı önererek ortaklığa kabulü reddedebilir."}},{"@type":"Question","name":"Hisseleri hayattayken çocuklarıma devretmek, veraset vergisinden daha mı avantajlı?","acceptedAnswer":{"@type":"Answer","text":"Vergi oranı açısından değil. İvazsız (bağış) intikallerde uygulanan oran %10 ile %30 arasında, veraset yoluyla intikaldeki %1 ile %10 aralığından belirgin şekilde yüksektir. Hayattayken devrin asıl avantajı, yönetim geçişini kontrollü ve planlı hale getirmesidir; vergi yükünü azaltmak için tek başına yeterli bir araç değildir."}},{"@type":"Question","name":"Veraset ve İntikal Vergisi'nin matrahı nasıl belirleniyor?","acceptedAnswer":{"@type":"Answer","text":"Mirasçıya intikal eden hissenin gerçek (rayiç) değeri üzerinden belirlenir. Halka açık olmayan bir aile şirketinde bu değerin objektif ve savunulabilir şekilde tespiti, bağımsız bir şirket değerleme çalışmasını gerektirir; aksi halde hem vergi idaresiyle hem diğer mirasçılarla anlaşmazlık riski doğar."}},{"@type":"Question","name":"Aile anayasası hukuken bağlayıcı mı?","acceptedAnswer":{"@type":"Answer","text":"Aile anayasasının kendisi, tek başına şirketler hukuku anlamında icra edilebilir bir belge değildir; ailenin ortak değerlerini ve niyetlerini yazıya döken bir mutabakat metnidir. Bağlayıcılığını güçlendirmek için önalım hakkı, devir kısıtlaması ve veto gibi kritik hükümlerinin, esas sözleşmeye veya noter onaylı ortaklar arası sözleşmelere de ayrıca işlenmesi gerekir."}}]}) }}
      />
    </BlogLayout>
  );
}
