  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Almanya'da şirket kurmak için Almanya'da ikamet etmek gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Türk vatandaşları Almanya'da ikamet etmeden, vekâletle veya bir seyahatle noter işlemlerini tamamlayarak şirket kurabilir. GmbH müdürünün (Geschäftsführer) de Almanya'da ikamet zorunluluğu yoktur, ancak vergi ve resmi yazışmalar için geçerli bir adres gösterilmesi gerekir."}},{"@type":"Question","name":"GmbH kurmak için tüm sermayeyi baştan yatırmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Standart GmbH'da 25.000 EUR'luk sermayenin en az yarısının (asgari 12.500 EUR) kuruluş anında şirket banka hesabına yatırılması yeterlidir; kalan kısım daha sonra tamamlanabilir."}},{"@type":"Question","name":"Almanya'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin Almanya'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-Almanya Çifte Vergilendirmeyi Önleme Anlaşması kapsamında Almanya'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"GmbH ile UG (haftungsbeschränkt) arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"UG, 1 EUR'dan itibaren kurulabilen, düşük maliyetli bir GmbH varyantıdır; ancak yıllık kârın en az %25'ini yasal yedek akçeye ayırma zorunluluğu bulunur. GmbH ise 25.000 EUR asgari sermaye ile kurulur, kâr dağıtımında bu kısıtlama olmadan ciddi ticari faaliyet planlayan çoğu yabancı yatırımcı için daha uygun bir seçenektir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Noter onayından Handelsregister tesciline kadar olan temel işlemler genellikle 1-3 hafta içinde tamamlanır; vergi numarası ve banka hesabı açılışı dahil edildiğinde toplam süreç 4-8 haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
