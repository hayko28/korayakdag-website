  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"ABD'de şirket kurmak için ABD'de ikamet etmek veya SSN sahibi olmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kuruluş ve EIN başvurusu tamamen uzaktan, SSN veya ITIN olmadan da yürütülebilir. Fiziksel bulunma gerekliliği genellikle yalnızca geleneksel bankalarda hesap açılışında ortaya çıkar; Mercury gibi fintech çözümleri bu kısıtı büyük ölçüde ortadan kaldırır."}},{"@type":"Question","name":"Yabancı sahipli bir LLC gerçekten ABD'de vergi ödemiyor mu?","acceptedAnswer":{"@type":"Answer","text":"ABD kaynaklı vergilendirilebilir geliri (effectively connected income) olmayan, yalnızca uluslararası müşterilere hizmet veren bir LLC için genellikle federal gelir vergisi doğmaz. Ancak bu durum, gelir olmasa dahi zorunlu olan Form 5472 ve pro forma Form 1120 bilgi beyanı yükümlülüğünü ortadan kaldırmaz; eksik dosyalamanın cezası form başına en az 25.000 USD'dir."}},{"@type":"Question","name":"Delaware mı, Wyoming mi seçmeliyim?","acceptedAnswer":{"@type":"Answer","text":"Yatırımcı/VC almayı planlamıyorsanız ve küçük-orta ölçekli bir LLC kuruyorsanız, düşük yıllık maliyeti ve eyalet kurumlar vergisinin olmaması nedeniyle Wyoming genellikle daha avantajlıdır. Kurumsal yatırım almayı hedefleyen bir C-Corp için ise Delaware, yatırımcıların standart beklentisi nedeniyle neredeyse zorunlu bir tercihtir."}},{"@type":"Question","name":"ABD'de kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin ABD'deki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-ABD Çifte Vergilendirmeyi Önleme Anlaşması kapsamında ABD'de ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Delaware ve Wyoming'de kuruluş belgesinin onaylanması genellikle 1-3 iş günü sürer. EIN alınması, telefon başvurusunda aynı gün, faksta yaklaşık 4 iş günü, posta yoluyla ise 4-5 haftaya kadar uzayabilir. Banka hesabı açılışı dahil edildiğinde toplam süreç birkaç haftaya kadar çıkabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
