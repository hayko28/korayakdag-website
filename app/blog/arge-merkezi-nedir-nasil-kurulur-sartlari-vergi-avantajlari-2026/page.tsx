  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"1. Ar-Ge Merkezi kurmak için minimum kaç personel gerekir?","acceptedAnswer":{"@type":"Answer","text":"Genel kural en az 15 tam zaman eşdeğer Ar-Ge personelidir. Motorlu taşıt, hava/uzay aracı, askeri araç ve motosiklet imalatı gibi belirli sektörlerde bu eşik 30 TZE personele yükselir."}},{"@type":"Question","name":"2. Şahıs şirketi Ar-Ge Merkezi kurabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Başvuru sahibinin kanuni veya iş merkezi Türkiye'de bulunan bir sermaye şirketi (anonim, limited vb.) olması gerekir."}},{"@type":"Question","name":"3. Ar-Ge Merkezi belgesi ne kadar sürede alınır?","acceptedAnswer":{"@type":"Answer","text":"Bakanlığın ön incelemesi 5 iş günü, eksiklik giderme süresi en geç 15 iş günü, Değerlendirme ve Denetim Komisyonu'nun kararı ise en geç 30 iş günü içinde tamamlanır. Dosyanın eksiksiz hazırlanması bu süreleri kısaltabilir."}},{"@type":"Question","name":"4. Gelir vergisi stopajı teşviki her personel için aynı oranda mı uygulanır?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Oran, personelin eğitim durumuna göre değişir: doktoralı veya temel bilimlerden yüksek lisanslı personelde %95, yüksek lisanslı veya temel bilimlerden lisanslı personelde %90, diğer personelde %80'dir."}},{"@type":"Question","name":"5. SGK işveren primi desteği ne kadardır?","acceptedAnswer":{"@type":"Answer","text":"Ar-Ge/tasarım personeli ile bunların azami %10'u kadar destek personelinin sigorta primi işveren hissesinin yarısı Hazine bütçesinden karşılanır."}},{"@type":"Question","name":"6. Bu teşvikler ne zamana kadar geçerli?","acceptedAnswer":{"@type":"Answer","text":"Gelir vergisi stopajı teşviki ve performansa dayalı ilave indirim gibi süreye bağlı unsurlar mevcut mevzuatta 31.12.2028 tarihine kadar öngörülmüştür. Kanunun uzatılıp uzatılmayacağı yasama sürecine bağlıdır; bu nedenle güncel durumun başvuru öncesinde teyit edilmesi önemlidir."}},{"@type":"Question","name":"7. Ar-Ge Merkezi ile Teknopark aynı anda kullanılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Şirketin farklı faaliyetleri için farklı yapılar tercih edilebilir; ancak aynı faaliyetin hem Ar-Ge Merkezi hem Teknopark teşviklerinden birlikte yararlanması mümkün değildir. Hangi yapının şirketin faaliyet ve personel yapısına daha uygun olduğu proje bazında değerlendirilmelidir."}},{"@type":"Question","name":"8. Yabancı uyruklu personel Ar-Ge Merkezi'nde çalıştırılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. 4817 sayılı Kanun ve ilgili mevzuat çerçevesinde yabancı uyruklu Ar-Ge/tasarım personeli çalıştırılabilir; çalışma izni başvuruları Sanayi ve Teknoloji Bakanlığı'nın uygun görüşü doğrultusunda sonuçlandırılır."}}]}) }}
      />
    </BlogLayout>
  );
}
