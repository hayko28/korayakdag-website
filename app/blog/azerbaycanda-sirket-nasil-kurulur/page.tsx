  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Azerbaycan'da şirket kurmak için ülkede fiziken bulunmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Noter onaylı ve apostilli bir vekâletname ile yerel temsilciye yetki verilerek tescil süreci baştan sona uzaktan yürütülebilir. Ancak banka hesabı açılışında bazı yerel bankalar yetkili imza sahibinin veya temsilcinin şubeye gelmesini isteyebilir."}},{"@type":"Question","name":"MMC kurmak için asgari sermaye şartı var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır, Azerbaycan mevzuatında MMC kuruluşu için asgari sermaye şartı bulunmuyor. Sermaye tutarı, ortakların iş planına ve ihtiyaç duyulan işletme sermayesine göre serbestçe belirlenebilir."}},{"@type":"Question","name":"Azerbaycan'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin Azerbaycan'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-Azerbaycan Çifte Vergilendirmeyi Önleme Anlaşması kapsamında Azerbaycan'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"Sadələşdirilmiş vergi rejiminden kim yararlanabilir?","acceptedAnswer":{"@type":"Answer","text":"Yıllık cirosu belirli bir eşiğin altında kalan ve KDV mükellefi olmayan küçük işletmeler, ciro üzerinden %2 oranında sadələşdirilmiş vergi ödeyerek kurumlar vergisinden muaf tutulabilir. Güncel eşik tutarı Vergilər Nazirliyi tarafından belirlenir ve mevzuat değişikliklerine tabidir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Belgeler eksiksiz olduğunda elektronik tescil genellikle 1-3 iş günü içinde tamamlanır. Vekâletname, apostil ve pasaport hazırlıkları dahil edildiğinde toplam süreç ortalama 1-2 hafta, banka hesabı açılışı dahil edildiğinde ise birkaç haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
