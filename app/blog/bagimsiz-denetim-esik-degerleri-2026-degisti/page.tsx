  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Yeni eşik değerler ne zaman yürürlüğe girdi?","acceptedAnswer":{"@type":"Answer","text":"17 Mart 2026 tarihli ve 33199 sayılı Resmî Gazete'de yayımlanan 11066 sayılı Cumhurbaşkanı Kararı, 1 Ocak 2026 ve sonrasında başlayan hesap dönemlerinde uygulanmak üzere yürürlüğe girdi."}},{"@type":"Question","name":"Şirketim geçen yıl kapsamdaydı, bu yıl da otomatik olarak kapsamda mı sayılır?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kapsam, her yıl güncel eşik değerlere göre, art arda iki hesap dönemi esas alınarak yeniden değerlendirilir. Eski eşiklere göre kapsamda olan bir şirket, yeni ve daha yüksek eşikler karşısında kapsam dışına çıkabilir; ancak bunun için resmî bir değerlendirme yapılması gerekir."}},{"@type":"Question","name":"Üç ölçütten sadece birini aşan bir şirket denetime tabi olur mu?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kapsama girmek için üç ölçütten (aktif toplamı, net satış hasılatı, çalışan sayısı) en az ikisinin eşik değerinin, art arda iki hesap döneminde aşılması gerekir. Tek bir ölçütün aşılması yeterli değildir."}},{"@type":"Question","name":"Kapsam dışında kalan bir şirket yine de bağımsız denetim yaptırabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Kanuni yükümlülük kapsamı dışında kalan şirketler de gönüllü olarak bağımsız denetim yaptırabilir. Banka, yatırımcı veya iş ortağı ilişkilerinde denetlenmiş finansal tablo sunmak isteyen şirketler için bu, ticari bir avantaja dönüşebilir."}},{"@type":"Question","name":"Halka açık olmayan bir sigorta veya finansman şirketi eşik değerine bakılmaksızın tabi midir?","acceptedAnswer":{"@type":"Answer","text":"Bankalar, sigorta/reasürans/emeklilik şirketleri ile finansal kiralama, faktoring ve finansman şirketleri gibi belirli faaliyet konusuna sahip kuruluşlar, genel kural olarak ölçek şartı aranmaksızın bağımsız denetime tabidir. Bu kategorideki bazı küçük ölçekli kuruluşlar için özel ve daha düşük eşikler uygulanabileceğinden, ilgili düzenleyici otoritenin (BDDK, SPK vb.) güncel mevzuatının kontrol edilmesi önerilir."}}]}) }}
      />
    </BlogLayout>
  );
}
