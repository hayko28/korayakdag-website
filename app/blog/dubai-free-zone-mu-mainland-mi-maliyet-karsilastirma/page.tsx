  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Free zone şirketi BAE içindeki bir firmaya fatura kesebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Doğrudan ve sınırsız şekilde kesemez. Yerel bir distribütör üzerinden çalışmak, mainland şube açmak veya Dubai'de 2025'te yürürlüğe giren düzenleme kapsamında DET ikili lisansı almak gerekir. Bu satışlardan doğan gelir, kurumlar vergisi tarafında nitelikli gelir sayılmaz."}},{"@type":"Question","name":"Free zone mainland'den her zaman daha mı ucuz?","acceptedAnswer":{"@type":"Answer","text":"Genellikle evet, ancak istisnaları var. Vizesiz veya tek vizeli bir free zone paketinin ilk yıl maliyeti 20.000-40.000 AED bandında kalırken mainland tipik olarak 40.000-90.000 AED bandındadır. Buna karşılık DIFC gibi üst segment serbest bölgelerin maliyeti çoğu mainland yapısını aşar."}},{"@type":"Question","name":"Danışmanlık geliri elde eden bir free zone şirketi %0 vergi öder mi?","acceptedAnswer":{"@type":"Answer","text":"Kural olarak hayır. Genel danışmanlık ve benzeri hizmet gelirleri nitelikli faaliyet listesinde yer almadığı için 375.000 AED üzerindeki kazanç %9 oranında vergilendirilir. Ciro 3 milyon AED'yi aşmıyorsa, süresi dolana kadar Küçük İşletme Muafiyeti seçeneği değerlendirilebilir."}},{"@type":"Question","name":"Free zone'dan mainland'e sonradan geçilebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Free zone lisansını kapatıp mainland şirketi kurmak mümkün olduğu gibi, mevcut free zone şirketini koruyup mainland'de şube açmak ya da ikili lisans almak da bir seçenektir. İkinci yol, vize ve banka ilişkisinin sıfırlanmaması açısından çoğu zaman daha az sürtünmelidir."}},{"@type":"Question","name":"KDV kaydı free zone şirketleri için de zorunlu mu?","acceptedAnswer":{"@type":"Answer","text":"Eşikler aynıdır. Son 12 ayda vergiye tabi arz toplamı 375.000 AED'yi aşan her şirket, free zone veya mainland ayrımı olmaksızın kayıt yaptırmak zorundadır. Bazı serbest bölgelerin KDV bakımından Designated Zone statüsü, yalnızca belirli mal hareketleri için özel sonuç doğurur, kayıt yükümlülüğünü ortadan kaldırmaz."}},{"@type":"Question","name":"BAE'de %0 vergi ödersem Türkiye'de hiç vergi ödemez miyim?","acceptedAnswer":{"@type":"Answer","text":"Tam tersi bir sonuç doğabilir. BAE'de vergi ödenmediğinde Türkiye'de mahsup edilecek bir tutar oluşmaz ve pasif gelir ağırlıklı yapılarda kontrol edilen yabancı kurum kuralları devreye girerek kâr dağıtılmasa bile Türkiye'de vergilendirme gündeme gelebilir. Yapı kurulmadan önce her iki ülke tarafı birlikte modellenmelidir."}}]}) }}
      />
    </BlogLayout>
  );
}
