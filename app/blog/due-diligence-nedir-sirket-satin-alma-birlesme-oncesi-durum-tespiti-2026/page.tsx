  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Due diligence ile şirket değerleme arasındaki fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Değerleme, şirketin ekonomik değerinin ne kadar olduğunu hesaplar. Due diligence ise bu değerlemenin dayandığı verilerin doğruluğunu ve şirketin görünürdeki tablosunun arkasındaki riskleri sorgular. İkisi genellikle birlikte yürütülür."}},{"@type":"Question","name":"Due diligence süreci kaç günde tamamlanır?","acceptedAnswer":{"@type":"Answer","text":"Süre; şirketin büyüklüğüne, belge düzenine ve incelemenin kapsamına göre değişir. Düzenli kayıtlara sahip orta ölçekli bir şirket için süreç genellikle birkaç haftayı bulur; karmaşık iştirak yapısı olan şirketlerde bu süre uzayabilir."}},{"@type":"Question","name":"Küçük ölçekli bir şirket satın alırken de due diligence gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet; işlemin büyüklüğü incelemenin kapsamını belirler, gerekliliğini ortadan kaldırmaz. Küçük ölçekli işlemlerde genellikle daha odaklı (kritik risk alanlarına yönelik) bir inceleme yeterli olabilir."}},{"@type":"Question","name":"Satıcı tarafın da due diligence yaptırması gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Satıcının kendi tarafında yürüttüğü inceleme \"vendor due diligence\" olarak adlandırılır; satışa çıkmadan önce kendi risklerini görmesini sağlar, süreci hızlandırır ve müzakerede sürprizlerle karşılaşma riskini azaltır."}},{"@type":"Question","name":"Due diligence sırasında ciddi bir risk bulunursa işlem iptal mi olur?","acceptedAnswer":{"@type":"Answer","text":"Her zaman değil. Bulgunun büyüklüğüne göre işlem iptal edilebilir, fiyat yeniden müzakere edilebilir veya sözleşmeye özel garanti/tazminat maddeleri eklenerek risk yönetilebilir."}},{"@type":"Question","name":"Rekabet Kurumu iznine tabi olup olmadığımı nasıl anlarım?","acceptedAnswer":{"@type":"Answer","text":"Bu, hukuki due diligence kapsamında incelenir; taraflardan birinin veya toplamının ciro rakamları güncel Tebliğ'deki eşiklerle karşılaştırılarak belirlenir. Rakamlar güncel mevzuata göre değişebildiği için işlem öncesinde mutlaka teyit edilmelidir."}}]}) }}
      />
    </BlogLayout>
  );
}
