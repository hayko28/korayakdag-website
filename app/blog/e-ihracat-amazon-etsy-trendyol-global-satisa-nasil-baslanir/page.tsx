  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"E-ihracata başlamak için şirket kurmam şart mı?","acceptedAnswer":{"@type":"Answer","text":"Trendyol Global ve Amazon için pratikte evet, en az bir şahıs şirketi (şahıs işletmesi) veya sermaye şirketi gerekiyor; vergi levhası, imza sirküleri gibi kurumsal belgeler isteniyor. Etsy'de ise el emeğiyle üretim yapan ve ciro muafiyet sınırının altında kalan bireysel üreticiler, esnaf vergi muafiyeti belgesiyle şirketsiz de başlayabilir; ancak ciro büyüdükçe şirketleşme neredeyse kaçınılmaz hâle gelir."}},{"@type":"Question","name":"Mikro ihracat limitini (600 kg / 30.000 Euro) aşarsam ne olur?","acceptedAnswer":{"@type":"Answer","text":"Bu sınırı aşan bir gönderi artık ETGB ile değil, standart gümrük beyannamesiyle ve bir gümrük müşaviri aracılığıyla işlem görür. Bu durumda süreç daha uzun sürer ve müşavirlik maliyeti doğar; düzenli olarak bu hacme yaklaşan satıcıların gönderilerini bölme veya konsolide taşıma stratejisini önceden planlaması gerekir."}},{"@type":"Question","name":"Amazon, Etsy ve Trendyol Global'e aynı anda satış yapabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Evet, üçü de birbirinden bağımsız hesaplar üzerinden yürüdüğü için teknik bir engel yok. Ancak stok, fiyat ve iade yönetimini birden fazla platformda eş zamanlı tutmak ek bir operasyonel yük getirir; çoğu satıcı önce tek bir platformda düzenli satış hacmine ulaşıp sonra ikinciye geçiyor."}},{"@type":"Question","name":"E-ihracat gelirlerimde KDV ödemem gerekiyor mu?","acceptedAnswer":{"@type":"Answer","text":"Hayır, ETGB ile gerçekleştirilen mikro ihracat satışları 3065 sayılı KDV Kanunu'nun 11/1-a maddesi kapsamında KDV'den istisnadır. Fatura %0 KDV ile kesilir; ürünü üretirken/tedarik ederken ödediğiniz KDV ise indirim veya iade yoluyla geri alınabilir."}},{"@type":"Question","name":"Ticaret Bakanlığı'nın e-ihracat desteğiyle mikro ihracat aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Mikro ihracat, gönderi bazlı işleyen bir gümrük kolaylığıdır; her paket için ayrı ETGB düzenlenir. Ticaret Bakanlığı'nın E-İhracat Destek Programı ise harcama bazlı işleyen ayrı bir teşvik mekanizmasıdır; pazaryeri komisyonu, fulfillment ve tanıtım gibi giderlerinizin bir kısmını ön onay sonrası geri ödemesiz olarak karşılar. İkisi aynı anda, birbirini tamamlayacak şekilde kullanılabilir."}},{"@type":"Question","name":"Hangi platformla başlamalıyım: Amazon, Etsy yoksa Trendyol Global mi?","acceptedAnswer":{"@type":"Answer","text":"Bu, ürününüzün tipine bağlı. El yapımı veya özel tasarım ürününüz varsa Etsy genellikle en düşük giriş maliyetli seçenek. Markalı, seri üretim bir ürününüz ve yurt dışında büyük hacimle satmayı hedefliyorsanız Amazon Global Selling daha uygun bir altyapı sunuyor. Zaten Trendyol'da aktif satış yapıyorsanız, en düşük ek yatırımla denenebilecek kanal Trendyol Global."}}]}) }}
      />
    </BlogLayout>
  );
}
