  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Franchise vermek için markamı tescillemem şart mı?","acceptedAnswer":{"@type":"Answer","text":"Evet. Franchise sisteminde franchise alanın satın aldığı ana varlık markadır. Tescilsiz bir marka üzerinden franchise verilirse, franchise alanın yatırımı hukuken korumasız kalır ve marka sahibi de kendi markasının başkaları tarafından kullanılmasını engelleyemeyebilir. TÜRKPATENT nezdinde tescil, franchise vermenin ön şartıdır."}},{"@type":"Question","name":"Franchise ile bayilik arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Bayilikte taraf sadece ürünü kendi adına satar, işletme modelini devralmaz. Franchise'da ise franchise alan; markanın adını, görsel kimliğini, operasyon standartlarını ve eğitim sistemini bir bütün olarak devralır, buna karşılık marka sahibinin denetimine tabi olur."}},{"@type":"Question","name":"Franchise sözleşmesi için ayrı bir kanun var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Türkiye'de franchise'ı doğrudan düzenleyen ayrı bir kanun bulunmuyor. Sözleşme, isimsiz bir sözleşme olarak Türk Borçlar Kanunu'nun genel hükümlerine göre taraflarca serbestçe kurgulanır; rekabet hukuku açısından ise Rekabet Kurumu'nun dikey anlaşma tebliği kapsamında değerlendirilir."}},{"@type":"Question","name":"Her franchise sözleşmesi Rekabet Kurumu'na bildirilmek zorunda mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Franchise verenin ilgili pazardaki payı %30'u aşmadığı sürece sözleşme otomatik olarak grup muafiyetinden yararlanır ve ayrı bir bildirim/izin süreci gerekmez. Küçük ve orta ölçekli çoğu marka için bu eşik pratikte sorun oluşturmaz."}},{"@type":"Question","name":"Royalty (ciro payı) oranı nasıl belirlenir?","acceptedAnswer":{"@type":"Answer","text":"Royalty oranı için sabit bir yasal düzenleme yok; oran, sektöre, markanın verdiği desteğin kapsamına ve pazardaki rekabet koşullarına göre taraflar arasında serbestçe belirlenir. Önemli olan, oranın franchise alan için sürdürülebilir bir kâr marjı bırakacak şekilde, gerçekçi ciro projeksiyonlarına dayanarak kurgulanmasıdır."}},{"@type":"Question","name":"Franchise sözleşmesi feshedilirse franchise alan markayı kullanmaya devam edebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır, ancak bu, sözleşmede ne kadar net yazıldığına bağlıdır. İyi kurgulanmış bir franchise sözleşmesi, fesih sonrası markanın kullanımının hangi sürede kesileceğini, tabela ve görsel unsurların ne zaman kaldırılacağını ve rekabet yasağının kapsamını açıkça tanımlar. Bu maddeler eksikse, fesih sonrası süreç ihtilaflı hale gelir."}}]}) }}
      />
    </BlogLayout>
  );
}
