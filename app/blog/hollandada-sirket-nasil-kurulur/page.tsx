...
export default function BlogPage() {
  return (
    <BlogLayout
      ...
      ctaHeading="Hollanda'da Şirket Kuruluşu İçin Destek Alın"
      ctaText="BV kuruluşu, noter ve KvK süreci, KDV numarası ve Hollanda'nın geniş çifte vergilendirme anlaşması ağının doğru kullanımı. Hollanda'da yapılanma sürecinizi baştan sona yönetiyoruz."
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Hollanda'da şirket kurmak için Hollanda'da ikamet etmek gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Türk vatandaşları Hollanda'da ikamet etmeden, noter huzurunda düzenlenmiş bir vekâletname ile BV kurabilir. Direktör ve hissedarların Hollanda'da ikamet zorunluluğu yoktur; yalnızca geçerli bir iş adresi ve noter işlemlerinin tamamlanması gerekir."}},{"@type":"Question","name":"BV kurmak için asgari sermaye şartı var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Hollanda'da BV kuruluşunda yasal bir asgari sermaye şartı bulunmaz; şirket 0,01 EUR'luk sembolik bir hisse sermayesiyle dahi kurulabilir. Sermaye tutarı, şirketin faaliyet hacmine ve kurumsal itibar hedeflerine göre belirlenir."}},{"@type":"Question","name":"Hollanda'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin Hollanda'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-Hollanda Çifte Vergilendirmeyi Önleme Anlaşması kapsamında Hollanda'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"BV ile NV arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"BV, hissedarlar için sınırlı sorumluluk sağlayan, asgari sermaye şartı olmayan ve hisseleri serbestçe devredilemeyen yapıdır; ticari faaliyet planlayan çoğu yabancı yatırımcı için en uygun seçenektir. NV ise en az 45.000 EUR asgari sermaye gerektiren, hisseleri halka arz edilebilen bir anonim şirket yapısıdır ve daha çok büyük ölçekli yatırımlar için tercih edilir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Noter randevusu ve KVK tescili genellikle birkaç iş günü içinde tamamlanır; vergi numarasının Belastingdienst tarafından atanması ile birlikte toplam süreç ortalama 1-2 hafta sürer. Banka hesabı açılışı dahil edildiğinde süreç birkaç haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
