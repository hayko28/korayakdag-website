  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"İngiltere'de şirket kurmak için İngiltere'de ikamet etmek gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Türk vatandaşları İngiltere'de ikamet etmeden, tamamen online olarak Companies House üzerinden Ltd kurabilir. Director ve shareholder'ların İngiltere'de ikamet zorunluluğu yoktur; yalnızca geçerli bir registered office adresi ve kimlik doğrulama adımının tamamlanması gerekir."}},{"@type":"Question","name":"Ltd kurmak için asgari sermaye şartı var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. İngiltere'de Ltd kuruluşunda yasal bir asgari sermaye şartı bulunmaz; şirket 1 GBP'lik sembolik bir hisse sermayesiyle dahi kurulabilir. Sermaye tutarı, şirketin faaliyet hacmine ve kurumsal itibar hedeflerine göre belirlenir."}},{"@type":"Question","name":"İngiltere'de kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin İngiltere'deki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-İngiltere Çifte Vergilendirmeyi Önleme Anlaşması kapsamında İngiltere'de ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"Ltd ile LLP arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Ltd, hissedarlar için sınırlı sorumluluk sağlayan, klasik sermaye şirketi yapısıdır ve ticari faaliyet planlayan çoğu yabancı yatırımcı için en uygun seçenektir. LLP ise en az iki ortak gerektiren, kâr paylaşımının ortaklar arasında doğrudan yapıldığı bir ortaklık yapısıdır ve daha çok profesyonel hizmet ortaklıkları için tercih edilir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Companies House'a online başvuru, kimlik doğrulama tamamlandıktan sonra genellikle 24 saat içinde sonuçlanır ve toplam süreç 3-5 gün içinde tamamlanabilir. UTR numarasının posta yoluyla ulaşması 10-15 gün, banka hesabı açılışı dahil edildiğinde toplam süreç 4-6 haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
