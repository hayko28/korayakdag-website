  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"3-5 çalışanı olan küçük bir atölye de İSG uzmanı bulundurmak zorunda mı?","acceptedAnswer":{"@type":"Answer","text":"İşyeri tehlikeli veya çok tehlikeli sınıftaysa evet, 31 Aralık 2024'ten bu yana çalışan sayısına bakılmaksızın zorunlu. Az tehlikeli sınıftaysa da 1 Ocak 2025'ten itibaren 50'den az çalışanı olan işyerleri de kapsama alındı; pratikte bugün neredeyse tüm işyerleri bu hizmeti almak zorunda."}},{"@type":"Question","name":"OSGB ile anlaşmak yerine kendi bünyemde uzman çalıştırabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Evet, özellikle çok tehlikeli sınıfta 10 ve üzeri çalışanı olan işyerlerinde işveren isterse tam veya yarı zamanlı kendi uzman/hekim kadrosunu kurabilir. Küçük işletmeler için ise maliyet açısından genelde OSGB ile aylık hizmet sözleşmesi yapmak daha uygun oluyor."}},{"@type":"Question","name":"Risk değerlendirmesini kendimiz mi yapmalıyız, dışarıdan mı aldırmalıyız?","acceptedAnswer":{"@type":"Answer","text":"Kanun, risk değerlendirmesinin işveren tarafından yaptırılmasını şart koşar; ekip işyeri hekimi, iş güvenliği uzmanı ve gerektiğinde çalışan temsilcisinden oluşur. Uygulamada bu çalışma genellikle OSGB'nin görevlendirdiği uzman ve hekim tarafından saha incelemesiyle yürütülür."}},{"@type":"Question","name":"İSG Kurulu ne zaman zorunlu, kurul kurmazsam ne olur?","acceptedAnswer":{"@type":"Answer","text":"50 ve üzeri çalışanı olan ve 6 aydan uzun süren sürekli işlerin yapıldığı işyerlerinde zorunludur. Kurul oluşturulmaması veya düzenli toplanmaması, denetimde tespit edilen ve idari para cezasına konu olan ihlallerden biridir."}},{"@type":"Question","name":"İSG cezaları tek seferlik mi, yoksa tekrarlanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Değişir. Bazı ihlaller (örneğin acil durum planı eksikliği) tespit anında tek seferlik kesilirken, uzman/hekim bulundurmama veya risk değerlendirmesinin sürdürülen eksikliği gibi ihlaller, aykırılık giderilmediği sürece her ay yeniden uygulanabilir."}},{"@type":"Question","name":"İSG uyumsuzluğu bir iş kazası davasında işvereni nasıl etkiler?","acceptedAnswer":{"@type":"Answer","text":"Güncel risk değerlendirmesi, eğitim kayıtları ve OSGB görevlendirmesi eksiksizse, mahkemede işverenin gerekli önlemleri aldığını göstermesi kolaylaşır. Bu belgeler eksikse, kazadan önce önlem alınmadığı yönünde güçlü bir karine oluşur ve hem SGK rücu davasında hem de tazminat davasında işverenin kusur oranı yükselebilir."}}]}) }}
      />
    </BlogLayout>
  );
}
