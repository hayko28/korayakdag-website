  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"İtalya'da şirket kurmak için İtalya'da ikamet etmek gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Türk vatandaşları İtalya'da ikamet etmeden, uzaktan vekâletle veya bir seyahatle noter işlemlerini tamamlayarak şirket kurabilir. Ancak Codice Fiscale, PEC ve tescilli adres gibi belgelerin önceden hazırlanması süreci hızlandırır."}},{"@type":"Question","name":"SRL kurmak için tüm sermayeyi baştan yatırmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Standart SRL'de 10.000 EUR'luk sermayenin en az %25'i (asgari 2.500 EUR) kuruluş anında bankaya yatırılması yeterlidir; kalan kısım daha sonra ödenebilir. Tek ortaklı SRL'lerde ise genellikle sermayenin tamamının peşin yatırılması istenir."}},{"@type":"Question","name":"İtalya'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin İtalya'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-İtalya Çifte Vergilendirmeyi Önleme Anlaşması kapsamında İtalya'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"SRL ile SRLS arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"SRLS, 1-9.999 EUR arası sermaye ile kurulabilen, düşük maliyetli ancak standart bir sözleşme şablonuna bağlı basitleştirilmiş bir yapıdır. SRL ise 10.000 EUR asgari sermaye ile kurulur, ortaklık sözleşmesinde tam özelleştirme imkânı sunar ve ciddi ticari faaliyet planlayan çoğu yabancı yatırımcı için daha uygun bir seçenektir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Codice Fiscale alımından Registro Imprese kaydına kadar olan temel işlemler genellikle 7-14 iş günü içinde tamamlanır; banka hesabı açılışı dahil edildiğinde toplam süreç 6-10 haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
