  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Karbon ayak izi nasıl hesaplanır, en basit anlatımla?","acceptedAnswer":{"@type":"Answer","text":"Kullanılan enerji/yakıt miktarı (faaliyet verisi), ilgili emisyon faktörüyle çarpılır ve sonuç ton karbondioksit eşdeğerine (tCO₂e) çevrilir. Kapsam 1 (doğrudan), Kapsam 2 (satın alınan enerji) ve gerekiyorsa Kapsam 3 (değer zinciri) için ayrı ayrı hesaplanan bu değerler toplanarak toplam karbon ayak izi elde edilir."}},{"@type":"Question","name":"CBAM raporlaması nasıl yapılır?","acceptedAnswer":{"@type":"Answer","text":"Türk üretici, ürün bazında Kapsam 1 ve elektrik kaynaklı Kapsam 2 emisyonunu ve varsa girdi malzemelerinin gömülü emisyonunu hesaplayıp AB'deki CBAM beyan sahibi ithalatçıya CBAM iletişim şablonu formatında iletir. İthalatçı bu veriyle yıllık beyanını hazırlar ve karşılık gelen sertifikayı teslim eder. Türk üreticinin kendisi doğrudan AB'ye beyan vermez; ancak beyanın doğruluğu tamamen kendi sağladığı veriye bağlıdır."}},{"@type":"Question","name":"KOBİ karbon nötr olmalı mı?","acceptedAnswer":{"@type":"Answer","text":"Çoğu KOBİ için karbon nötr olmak yasal bir zorunluluk değil. Öncelik, doğru ve doğrulanabilir bir emisyon ölçümü yapmaktır; karbon nötr/net sıfır hedefi ise stratejik bir tercih olarak, ölçülmüş veri ve gerçekçi bir azaltım planına dayanarak değerlendirilmelidir."}},{"@type":"Question","name":"Karbon ayak izi hesaplaması ile TSRS raporu aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Karbon ayak izi hesaplaması bir veri üretim sürecidir; TSRS ise bu verinin (iklim etkisi, risk ve fırsatlarla birlikte) kurumsal düzeyde ve bağımsız güvence denetimine tabi şekilde açıklanmasını gerektiren bir raporlama çerçevesidir. TSRS raporunun iklim bölümü, karbon ayak izi hesaplamasının çıktısını kullanır."}},{"@type":"Question","name":"Hesaplamayı kendi içimizde mi yapmalıyız, dışarıdan destek mi almalıyız?","acceptedAnswer":{"@type":"Answer","text":"Basit bir ön envanter kurum içinde başlatılabilir; ancak CBAM beyanına veya TSRS güvence denetimine esas teşkil edecek hesaplamanın metodolojik olarak doğru kurulması ve doğrulamaya hazır belgelendirilmesi, uygulamalı deneyim gerektirir. Yanlış kurulan bir metodoloji, ilerleyen dönemde yeniden çalışma maliyetine yol açar."}}]}) }}
      />
    </BlogLayout>
  );
}
