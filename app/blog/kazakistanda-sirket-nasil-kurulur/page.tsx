  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Kazakistan'da şirket kurmak için ülkede fiziken bulunmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Noter onaylı ve apostilli bir vekâletname ile yerel temsilciye yetki verilerek TOO tescil süreci büyük ölçüde uzaktan yürütülebilir. Ancak banka hesabı açılışında çoğu banka yetkili imza sahibinin şubeye gelmesini talep eder."}},{"@type":"Question","name":"AIFC şirketi gerçekten %0 vergi mi öder?","acceptedAnswer":{"@type":"Answer","text":"Yalnızca nitelikli faaliyet (qualifying/priority activity) listesine giren ve \"esaslı varlık\" (substance) şartlarını sağlayan AIFC katılımcıları, ilgili gelirleri için 1 Ocak 2066'ya kadar %0 kurumlar vergisinden yararlanır. Bu şartları sağlamayan gelirler standart %20 oranına tabi olabilir."}},{"@type":"Question","name":"TOO kurmak için asgari sermaye şartı var mı?","acceptedAnswer":{"@type":"Answer","text":"Küçük işletme statüsündeki TOO'lar için asgari sermaye şartı sembolik düzeydedir. Orta ve büyük ölçekli şirketlerde ise Aylık Hesaplama Endeksi'nin 100 katı tutarında nominal bir kayıtlı sermaye öngörülür; bu tutar işletme sermayesi ihtiyacına göre serbestçe belirlenebilir."}},{"@type":"Question","name":"Kazakistan'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin Kazakistan'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-Kazakistan Çifte Vergilendirmeyi Önleme Anlaşması kapsamında Kazakistan'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Belgeler eksiksiz olduğunda elektronik tescil genellikle 1 iş günü içinde onaylanır. Vekâletname, apostil ve tercüme hazırlıkları dahil edildiğinde TOO için toplam süreç ortalama 1-3 hafta, AIFC şirketi için ise yaklaşık 3 iş günü; banka hesabı açılışı dahil edildiğinde ise birkaç haftaya kadar uzayabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
