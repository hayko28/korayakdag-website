  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Kazakistan'da KDV oranı 2026'da kaç oldu?","acceptedAnswer":{"@type":"Answer","text":"Standart KDV oranı 1 Ocak 2026'dan itibaren %12'den %16'ya yükseldi. İlaç, tıbbi cihaz ve lisanslı sağlık hizmetlerinde 2026 için %5 (2027'den itibaren %10), yurt içi süreli yayınlarda %10 ve ihracatta %0 oran uygulanıyor."}},{"@type":"Question","name":"KDV mükellefi olmak için ciro sınırı nedir?","acceptedAnswer":{"@type":"Answer","text":"Zorunlu KDV kayıt eşiği 10.000 AHE'dir. 2026 için AHE 4.325 tenge olduğundan bu yaklaşık 43,25 milyon tengeye denk gelir. Eşik aşıldıktan sonra 5 iş günü içinde başvuru yapılması gerekir; tek işlemle eşiğin aşılacağı hallerde başvuru teslimden önce yapılmalıdır."}},{"@type":"Question","name":"Astana Hub'a yabancı sermayeli bir şirket katılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Yabancı ortaklı şirketler Astana Hub katılımcısı olabilir. Belirleyici olan ortaklık yapısı değil, cironun en az %90'ının uygun bilişim faaliyetlerinden elde edilmesi ve bilişim hizmetleri gelirinde kurumlar vergisi indirimi için gerekli personel ve kaynak yeterliliğinin yıllık olarak teyit edilmesidir."}},{"@type":"Question","name":"AIFC'deki %0 vergi avantajı Türkiye'de sorun yaratır mı?","acceptedAnswer":{"@type":"Answer","text":"Yaratabilir. Türkiye'de yerleşik ortaklar iştiraki kontrol ediyorsa, iştirakin geliri ağırlıklı olarak pasif nitelikliyse ve efektif vergi yükü %10'un altındaysa, kontrol edilen yabancı kurum kuralı gereği kazanç dağıtılmasa bile Türkiye'de vergilendirilebilir. Yapının bu açıdan önceden değerlendirilmesi gerekir."}},{"@type":"Question","name":"Kazakistan'dan Türkiye'ye temettü transferinde stopaj kaç?","acceptedAnswer":{"@type":"Answer","text":"İç mevzuattaki genel oran %15'tir. Türkiye-Kazakistan Çifte Vergilendirmeyi Önleme Anlaşması kapsamında bu oran %10 olarak uygulanabilir; anlaşma oranından yararlanmak için mukimlik belgesinin ibrazı şarttır. Payın 3 yıldan uzun elde tutulması ve diğer şartların birlikte sağlanması halinde tam istisna da mümkündür."}},{"@type":"Question","name":"Astana Hub avantajları 2029'dan sonra devam edecek mi?","acceptedAnswer":{"@type":"Answer","text":"Mevcut düzenleme, vergi ayrıcalıklarının 1 Ocak 2029'a kadar geçerli olduğunu öngörüyor. Uzatılıp uzatılmayacağı bugün itibarıyla belirsizdir. Uzun vadeli yapılanma kararlarında bu tarihin bir senaryo olarak planlanması, teşvik sona erdiğinde yapının nasıl devam edeceğinin baştan belirlenmesi gerekir."}},{"@type":"Question","name":"Kazakistan'da işveren üzerindeki toplam bordro yükü ne kadar?","acceptedAnswer":{"@type":"Answer","text":"İşveren tarafında sosyal vergi %6, sosyal katkı payı %5, sağlık sigortası payı %3 ve işveren emeklilik katkısı %3,5 olarak uygulanır. Sosyal vergi, ödenen sosyal katkı payı kadar mahsup edilerek beyan edilir. Çalışan tarafında ise %10 emeklilik katkısı, %2 sağlık katkısı ve artan oranlı gelir vergisi bulunur."}}]}) }}
      />
    </BlogLayout>
  );
}
