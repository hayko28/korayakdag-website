  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"KDV iadesi ne kadar sürede ödenir?","acceptedAnswer":{"@type":"Answer","text":"Bu, seçilen yönteme bağlıdır. Belgesiz nakden iadede kontrol raporu olumlu ise süreç kısa sürer; YMM raporu + teminat mektubu ile talep edilen iadeler genellikle 5 iş günü içinde sonuçlanır. Teminatsız/YMM raporsuz, vergi inceleme raporuna bağlı taleplerde ise süreç incelemenin sırasına göre aylarca uzayabilir."}},{"@type":"Question","name":"Mahsuben iade ile nakden iade arasındaki fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Mahsuben iadede KDV alacağı, mükellefin kendi vergi (ve SGK prim) borçlarına karşılık işlenir; nakit çıkışı olmaz. Nakden iadede ise alacak, mükellefin banka hesabına aktarılır ve genellikle daha sıkı belge/teminat şartlarına tabidir."}},{"@type":"Question","name":"Tam Tasdik sözleşmesi olmadan KDV iadesi alınabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet, belirli limitlerin altındaki talepler için Tam Tasdik sözleşmesi şart değildir. Ancak limit üzerindeki talepler, Tam Tasdik sözleşmesi yoksa teminat mektubu veya vergi inceleme raporu ile sonuçlandırılabilir; bu da süreci genellikle uzatır."}},{"@type":"Question","name":"KDV iade talebi için son başvuru süresi ne zamana kadardır?","acceptedAnswer":{"@type":"Answer","text":"İade hakkı, işlemin gerçekleştiği dönemi izleyen ikinci takvim yılının sonuna kadar talep edilebilir. Bu süre içinde standart dilekçe dahil tüm belgelerin sisteme yüklenmiş olması gerekir; aksi halde iade hakkı zamanaşımına uğrar."}},{"@type":"Question","name":"İndirimli orana tabi işlemlerde KDV iadesi ne zaman talep edilir?","acceptedAnswer":{"@type":"Answer","text":"Yıl içindeki mahsuben iade talepleri her dönem yapılabilir; yıl içinde mahsup edilemeyen tutarın nakden iadesi ise ilgili yılın tamamlanmasından sonra, izleyen yılın Kasım dönemine kadar talep edilebilir. Güncel usul ve tutar için ilgili tebliğin kontrol edilmesi gerekir."}}]}) }}
      />
    </BlogLayout>
  );
}
