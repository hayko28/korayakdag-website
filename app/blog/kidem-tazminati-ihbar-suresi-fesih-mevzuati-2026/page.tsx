  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Kıdem tazminatı hangi durumlarda ödenmez?","acceptedAnswer":{"@type":"Answer","text":"İşçinin kendi isteğiyle, haklı bir neden göstermeden istifa etmesi halinde ve işverenin İş Kanunu m.25/II (ahlak ve iyiniyet kurallarına aykırılık) kapsamında yaptığı haklı nedenle fesihte kıdem tazminatı ödenmez. Diğer tüm haklı fesih kategorilerinde (sağlık, zorlayıcı sebep, tutukluluk) ve işverenin geçerli/geçersiz sebeple yaptığı olağan fesihlerde kıdem tazminatı doğar."}},{"@type":"Question","name":"İhbar süresine uyulmadan yapılan fesih geçersiz mi olur?","acceptedAnswer":{"@type":"Answer","text":"Hayır, fesih geçerli olur; ancak bildirim süresine uyulmamışsa, o süreye karşılık gelen ücret tutarı ihbar tazminatı olarak ödenmek zorundadır. İstisna, İş Kanunu m.25 kapsamındaki haklı nedenle derhal fesihlerdir; bu hallerde ihbar süresi/tazminatı aranmaz."}},{"@type":"Question","name":"İşe iade davası açma süresi ne kadardır?","acceptedAnswer":{"@type":"Answer","text":"İş güvencesi kapsamındaki bir çalışan, fesih bildiriminin tebliğinden itibaren 1 ay içinde arabulucuya başvurmak zorundadır. Arabuluculukta anlaşma sağlanamazsa, son tutanak tarihinden itibaren 2 hafta içinde işe iade davası açılabilir."}},{"@type":"Question","name":"Deneme süresindeki bir çalışan için ihbar/kıdem tazminatı ödenir mi?","acceptedAnswer":{"@type":"Answer","text":"Deneme süresi içinde (genellikle 2 ay, toplu iş sözleşmesiyle 4 aya kadar uzatılabilir) taraflardan biri sözleşmeyi bildirim süresi ve tazminat ödemeksizin sona erdirebilir. Ancak çalışılan günlere ait ücret ve diğer haklar eksiksiz ödenmek zorundadır."}},{"@type":"Question","name":"Performans düşüklüğü nedeniyle yapılan fesihte kıdem tazminatı ödenir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Performans düşüklüğü, m.25/II'deki ahlak/iyiniyet kurallarına aykırılık kategorisine girmez; işverenin geçerli sebeple yaptığı bu tür fesihlerde kıdem ve ihbar tazminatı ödenir. İş güvencesi kapsamındaki çalışanlarda ayrıca performans düşüklüğünün somut kriterlerle (hedef, uyarı, savunma) belgelenmesi, işe iade riskini azaltmak için önemlidir."}}]}) }}
      />
    </BlogLayout>
  );
}
