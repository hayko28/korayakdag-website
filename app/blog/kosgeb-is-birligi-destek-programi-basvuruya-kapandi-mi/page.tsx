  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"KOSGEB İş Birliği Destek Programı'na şu an başvurabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Hayır. KOSGEB'in resmî sitesine göre program 28.02.2025 tarihinde başvuruya kapatıldı ve \"Yürürlükten Kaldırılan Destekler\" listesine alındı. Yeni başvuru kabul edilmiyor."}},{"@type":"Question","name":"Program tamamen mi bitti, yoksa geçici bir süre için mi kapalı?","acceptedAnswer":{"@type":"Answer","text":"KOSGEB bu programı, birçok başka destekle birlikte \"yürürlükten kaldırılan\" kategorisine aldı. Bu, dönemsel çağrı kapanışı (ör. yılda birkaç kez açılıp kapanan bir program) değil, programın uygulamadan tamamen kaldırıldığı anlamına geliyor. KOSGEB yeniden açılacağına dair resmî bir takvim paylaşmadı."}},{"@type":"Question","name":"Daha önce onaylanan bir İş Birliği projem var, desteğim kesildi mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kapanış yalnızca yeni başvuru kabulünü durduruyor. 28 Şubat 2025'ten önce onaylanmış ve destek süreci devam eden projeler, taahhüt ve ödeme süreçlerini kendi programı kapsamında tamamlıyor."}},{"@type":"Question","name":"İş Birliği Destek Programı ile İşbirliği-Güçbirliği Destek Programı aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Aynı temel mantığa (birden fazla işletmenin ortak proje yürütmesi) dayanıyor ama farklı dönemlerin farklı kurallarına sahip. İşbirliği-Güçbirliği ismi, 3 Haziran 2022'deki güncellemeden önceki döneme ait; sonrasında program \"İş Birliği Destek Programı\" adıyla ve güncellenmiş oran/ limitlerle devam etti."}},{"@type":"Question","name":"Ortak üretim/ortak yatırım için başka hangi destek programına bakabilirim?","acceptedAnswer":{"@type":"Answer","text":"İhtiyacınızın niteliğine göre değişir: tedarikçi geliştirme amaçlı iş birlikleri için Kapasite Geliştirme Destek Programı'nın ilgili istisnasına, ihracat odaklı grup projeleri için Ticaret Bakanlığı'nın UR-GE projelerine, ortak bir eğitim/danışmanlık merkezi kurmak için SEGEM Destek Programı'na bakabilirsiniz. Hiçbiri İş Birliği Destek Programı'nın birebir muadili değil, her birinin kendi şartları var."}},{"@type":"Question","name":"Programın güncel durumunu nereden teyit edebilirim?","acceptedAnswer":{"@type":"Answer","text":"En güvenilir kaynak her zaman kosgeb.gov.tr'nin kendi destek sayfaları ve \"Yürürlükten Kaldırılan Destekler\" listesi. Üçüncü taraf danışmanlık sitelerindeki güncelleme tarihleri yanıltıcı olabilir; bu yazıyı hazırlarken de resmî olmayan bazı kaynaklarda programın hâlâ aktif gösterildiğini, ancak KOSGEB'in kendi sitesinin bunu doğrulamadığını gördük."}}]}) }}
      />
    </BlogLayout>
  );
}
