    ...
    >
        ...
        <section className="mt-24 scroll-mt-24">
          <div className="rounded-2xl border-l-4 border-orange-500 bg-orange-50 p-8">
            <h3 className="mb-4 text-2xl font-bold text-[#071A2F]">
              🤝 Kapasite Geliştirme Kredisi Başvurunuzda Yanınızdayız
            </h3>
            <p className="leading-8 text-gray-700">
              3. dönem başvurusu için Sanayi Sicil Belgesi, YODA raporu ve
              hızlı büyüyen işletme şartlarının eksiksiz sağlanması,
              20-30 milyon TL&apos;lik kredi limitinden yararlanma
              sürecini hızlandırır.{" "}
              <Link href="/#contact" className="text-orange-600 underline">
                Başvuru dosyanızı birlikte hazırlamak için bizimle
                iletişime geçin.
              </Link>
            </p>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Şu anda başvuru dönemi açık mı?","acceptedAnswer":{"@type":"Answer","text":"Evet. 2026 yılı 3. başvuru dönemi 22 Ağustos 2026'da başladı ve 15 Eylül 2026'da sona erecek. Bu tarihten sonra başvuru yapabilmek için KOSGEB'in yeni bir dönem ilan etmesi gerekir."}},{"@type":"Question","name":"Kredi üst limiti gerçekten 30 milyon TL mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır, sadece belirli bir kategori için. Genel kredi üst limiti 20 milyon TL'dir. 30 milyon TL yalnızca savunma, havacılık ve uzay alanında tedarikçi geliştirmeye yönelik iş birliği yapan ve EYDEP-A sertifikasına sahip işletmeler için geçerlidir (EYDEP-B: 27,5 milyon TL, EYDEP-C: 25 milyon TL)."}},{"@type":"Question","name":"Sanayi Sicil Belgem yok, yine de başvurabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"NACE Kısım C – İmalat sektöründeyseniz bu belge zorunludur; ancak başvurudan önce e-Devlet veya Sanayi Sicil Bilgi Sistemi üzerinden hızlıca başvurup alabilirsiniz. İmalat dışı kapsamdaki NACE kodlarında (61, 62, 63, 72) faaliyet gösteriyorsanız bu belge aranmaz."}},{"@type":"Question","name":"\"Hızlı büyüyen işletme\" şartını sağlamıyorum, başvuramaz mıyım?","acceptedAnswer":{"@type":"Answer","text":"Teknogirişim Rozetiniz varsa veya KOSGEB'in belirlediği sektörlerde tedarikçi geliştirme protokolü kapsamında bildirilen işletmeler arasındaysanız bu şarttan muafsınız. Bu iki istisnadan hiçbirini karşılamıyorsanız, ilgili dönem için başlangıç yılı ve büyüme oranı kriterlerini sağlamadan başvuru yapamazsınız."}},{"@type":"Question","name":"Program hibe mi, kredi mi?","acceptedAnswer":{"@type":"Answer","text":"İkisinin karışımı gibi çalışır. İşletme bankadan kredi kullanır ve anaparayı geri öder; KOSGEB ise kredinin faiz/kâr payı giderinin 20 puana kadar olan kısmını geri ödemesiz olarak işletmeye öder."}},{"@type":"Question","name":"Şahıs şirketleri başvurabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Programa yalnızca limited veya anonim şirket statüsündeki işletmeler başvurabilir."}},{"@type":"Question","name":"Kredi hangi bankadan kullanılıyor?","acceptedAnswer":{"@type":"Answer","text":"KOSGEB'in protokol imzaladığı T.C. Ziraat Bankası, Türkiye Halk Bankası, Türkiye Vakıflar Bankası ve Ziraat Katılım Bankası'ndan kullanılır; proje kapsamında yalnızca tek bir finansal kuruluştan kredi sağlanabilir. Kredi başvurusu, ilgili bankanın kendi değerlendirme kriterlerine de tabidir."}},{"@type":"Question","name":"Danışmanlık desteği almak zorunlu mu?","acceptedAnswer":{"@type":"Answer","text":"Hayır, zorunlu değildir. Ancak proje başvuru formunun doğru kurgulanması, Sanayi Sicil Belgesi/YODA sürecinin zamanında yönetilmesi ve Kurul sürecinin doğru izlenmesi onay ihtimalini ve alınacak destek tutarını doğrudan etkilemektedir."}}]}) }}
      />
    </BlogLayout>
  );
}
