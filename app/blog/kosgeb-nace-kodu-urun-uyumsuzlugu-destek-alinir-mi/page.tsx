  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"NACE kodum destek kapsamındaki sektörler listesinde değilse hiç başvuramaz mıyım?","acceptedAnswer":{"@type":"Answer","text":"Mevcut kayıtlı kodunuzla listede yer almıyorsanız o programa başvuramazsınız. Ancak fiili faaliyetiniz gerçekten kapsam içindeki bir alana giriyorsa, kodunuzu fiili duruma uygun şekilde güncelleyerek uygunluk kazanmanız mümkündür."}},{"@type":"Question","name":"Vergi levhamdaki ana faaliyet kodu ile ticaret sicilindeki faaliyet konusu farklı olabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet, sık görülen bir durumdur. Ticaret sicilindeki amaç ve konu maddesi genellikle çok geniş tutulur ve onlarca faaliyeti kapsayabilir. KOSGEB değerlendirmesinde belirleyici olan bu geniş liste değil, vergi dairesindeki ana faaliyet kodudur."}},{"@type":"Question","name":"NACE kodu güncelleme işlemi ücretli mi, ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Sadece vergi dairesi ve MERSİS üzerinden yapılan kod güncellemesi genellikle ücretsizdir ve kısa sürede sonuçlanır. Ancak esas sözleşme tadili gerekiyorsa noter, Ticaret Sicili Gazetesi ilanı ve tescil harçları doğar; bu durumda süreç birkaç haftaya kadar uzayabilir."}},{"@type":"Question","name":"Destek başvurusu onaylandıktan sonra NACE kodu uyumsuzluğu fark edilirse ne olur?","acceptedAnswer":{"@type":"Answer","text":"Uyumsuzluk sonradan tespit edilirse destek durdurulabilir, daha önce ödenen tutarlar KOSGEB Uygunsuzluk Yönergesi çerçevesinde yasal faiziyle birlikte geri istenebilir ve işletme KBS üzerinde pasif hale getirilerek yeni destekten yararlanması engellenebilir."}},{"@type":"Question","name":"Birden fazla NACE kodum varsa hangisi esas alınır?","acceptedAnswer":{"@type":"Answer","text":"Genel kural olarak vergi dairesindeki ana faaliyet kodu esas alınır. Bazı programlarda beyannamede kayıtlı yardımcı (ikincil) faaliyet kodları da ek olarak değerlendirmeye girebilir, ancak bu her program için otomatik geçerli bir kural değildir; başvuracağınız programın güncel uygulama esaslarından teyit edilmesi gerekir."}},{"@type":"Question","name":"Sanayi Sicil Belgesi almak NACE kodu sorununu otomatik çözer mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Sanayi Sicil Belgesi, imalat esaslı programlarda fiili üretim konusunu doğrulayan ayrı bir belgedir ve vergi dairesindeki NACE kodunun yerine geçmez. İkisinin birbiriyle tutarlı olması, başvurunuzun güçlü ve sorgusuz değerlendirilmesi açısından önemlidir."}}]}) }}
      />
    </BlogLayout>
  );
}
