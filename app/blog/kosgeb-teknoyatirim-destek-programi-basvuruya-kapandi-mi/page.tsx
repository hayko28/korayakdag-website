  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"KOSGEB TEKNOYATIRIM Destek Programı'na şu an başvurabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Hayır. KOSGEB'in resmî sitesine göre program 30.06.2025 tarihinde başvuruya kapatıldı ve \"Yürürlükten Kaldırılan Destekler\" listesine alındı. Yeni başvuru kabul edilmiyor."}},{"@type":"Question","name":"Program tamamen mi bitti, yoksa geçici bir süre için mi kapalı?","acceptedAnswer":{"@type":"Answer","text":"KOSGEB bu programı, birçok başka destekle birlikte \"yürürlükten kaldırılan\" kategorisine aldı. Bu, dönemsel çağrı kapanışı değil, programın uygulamadan tamamen kaldırıldığı anlamına geliyor. KOSGEB yeniden açılacağına dair resmî bir takvim paylaşmadı."}},{"@type":"Question","name":"Daha önce onaylanan bir TEKNOYATIRIM projem var, desteğim kesildi mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kapanış yalnızca yeni başvuru kabulünü durduruyor. 30 Haziran 2025'ten önce onaylanmış ve yatırım süreci devam eden projeler, taahhüt ve ödeme süreçlerini kendi programı kapsamında tamamlıyor."}},{"@type":"Question","name":"TEKNOYATIRIM ile Ar-Ge, Ür-Ge ve İnovasyon Destek Programı aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Ar-Ge, Ür-Ge ve İnovasyon Destek Programı, ürün henüz ortaya çıkmadan geliştirme faaliyetinin kendisini destekliyor ve hâlâ yürürlükte. TEKNOYATIRIM ise bu geliştirme sürecinin sonucunda ortaya çıkan ürünün seri üretime geçirilmesi için yapılan yatırımı destekliyordu ve artık kapalı."}},{"@type":"Question","name":"Ar-Ge sonucu ürettiğim ürünün seri üretim yatırımı için başka hangi destek programına bakabilirim?","acceptedAnswer":{"@type":"Answer","text":"İhtiyacınızın büyüklüğüne ve niteliğine göre değişir: genel üretim kapasitesi yatırımları için Kapasite Geliştirme Destek Programı'na, HAMLE onaylı ürünler için Stratejik Ürün Destek Programı'na, büyük ölçekli yatırımlar için Yatırım Teşvik Belgesi'ne bakabilirsiniz. Hiçbiri TEKNOYATIRIM'ın birebir muadili değil, her birinin kendi şartları var."}},{"@type":"Question","name":"Programın güncel durumunu nereden teyit edebilirim?","acceptedAnswer":{"@type":"Answer","text":"En güvenilir kaynak her zaman kosgeb.gov.tr'nin kendi destek sayfaları ve \"Yürürlükten Kaldırılan Destekler\" listesi. Bu yazıyı hazırlarken de birçok üçüncü taraf danışmanlık sitesinde ve hatta KOSGEB'in kendi eski destek sayfasının arşivlenmiş halinde programın hâlâ aktif gösterildiğini, ancak resmî kapanış listesinin bunu doğrulamadığını gördük."}}]}) }}
      />
    </BlogLayout>
  );
}
