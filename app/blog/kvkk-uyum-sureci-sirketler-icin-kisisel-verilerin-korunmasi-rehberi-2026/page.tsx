  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Küçük bir şirket olarak KVKK'dan tamamen muaf olabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Çalışan sayısı ve bilanço eşiklerinin altında kalan şirketler yalnızca VERBİS'e kayıt yükümlülüğünden istisna tutulabilir; aydınlatma yükümlülüğü, veri güvenliği tedbirleri ve ilgili kişi başvurularına cevap verme yükümlülüğü ölçekten bağımsız olarak devam eder."}},{"@type":"Question","name":"VERBİS'e kayıt olmam gerekip gerekmediğini nasıl anlarım?","acceptedAnswer":{"@type":"Answer","text":"Öncelikle şirketinizin yıllık ortalama çalışan sayısı ve son onaylı mali bilanço toplamını, güncel istisna eşikleriyle karşılaştırmanız gerekir. Özel nitelikli veri (sağlık, biyometrik vb.) işleme faaliyetiniz varsa daha düşük bir eşik uygulanabileceğini unutmayın. Şüpheli durumlarda profesyonel bir değerlendirme almanız önerilir."}},{"@type":"Question","name":"Aydınlatma metni ile açık rıza formunu tek bir belgede birleştirebilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Bu iki belgenin ayrı tutulması önerilir. Aydınlatma her durumda zorunludur ve rızaya bağlı değildir; açık rıza ise yalnızca gerekli olduğu durumlarda, konuya özgü ve ayrıca alınmalıdır. Birleştirilmiş, genel-geçer bir metin, denetimde geçersiz rıza olarak değerlendirilme riski taşır."}},{"@type":"Question","name":"Veri ihlalini fark ettim ama emin değilim, yine de bildirmem gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Kişisel verilerin kanuni olmayan yollarla üçüncü kişilerin eline geçtiğine dair makul bir şüphe varsa, 72 saatlik süre işlemeye başlar. Belirsizlik durumunda dahi erken harekete geçip ön bildirimde bulunmak, sürecin gecikmesinden daha az risklidir."}},{"@type":"Question","name":"KVKK uyum sürecini ne kadar sürede tamamlayabilirim?","acceptedAnswer":{"@type":"Answer","text":"Şirketin büyüklüğüne ve veri işleme faaliyetlerinin karmaşıklığına bağlı olarak değişmekle birlikte, envanter çalışması genellikle birkaç haftayı bulur; politika, aydınlatma metni ve gerekiyorsa VERBİS kaydı dahil sürecin tamamı genellikle birkaç ay içinde tamamlanabilir. Süreç bir kez kurulduktan sonra periyodik güncelleme gerektirir."}}]}) }}
      />
    </BlogLayout>
  );
}
