  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Yatırım tutarım Yatırım Teşvik Belgesi'nin asgari şartını karşılamıyorsa hiç şansım yok mu?","acceptedAnswer":{"@type":"Answer","text":"Belgeyi bu yatırımla alamazsınız ama bu, devlet desteğinden tamamen mahrum kalacağınız anlamına gelmez. Bu tutar aralığında KOSGEB Kapasite Geliştirme veya (yeni kurulan bir işletmeyseniz) Girişimci Destek Programı genelde daha gerçekçi bir seçenektir."}},{"@type":"Question","name":"KOSGEB kredisi ile bankadan alacağım normal krediden farkı nedir?","acceptedAnswer":{"@type":"Answer","text":"Kredinin kendisi banka üzerinden kullandırılır ve anapara normal şekilde geri ödenir. KOSGEB'in sağladığı fark, kredinin faiz veya kâr payı giderinin belirli bir puanlık kısmını sizin yerinize karşılamasıdır; bu da toplam finansman maliyetinizi düşürür."}},{"@type":"Question","name":"Yatırım Teşvik Belgesi almak için mutlaka büyük ölçekli bir şirket mi olmam gerekiyor?","acceptedAnswer":{"@type":"Answer","text":"Hayır, KOBİ'ler de belge alabilir. Belirleyici olan şirket ölçeğinden çok, yatırımınızın bölgeye göre değişen asgari sabit yatırım tutarını karşılaması ve faaliyetinizin desteklenen sektörler listesinde yer almasıdır."}},{"@type":"Question","name":"Aynı makineyi hem KOSGEB'e hem Yatırım Teşvik Belgesi'ne başvururken gösterebilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Güncel düzenleme, yatırım teşvik kararları kapsamında desteklenen bir harcamanın KOSGEB'e, KOSGEB'den desteklenen bir harcamanın da yatırım teşvik kapsamına sunulamayacağını açıkça belirtiyor. Bu bir mükerrer destek sayılır ve tespit edilirse geri tahsil riski doğurur."}},{"@type":"Question","name":"Önce KOSGEB'e başvurup sonra aynı işletme için Yatırım Teşvik Belgesi alabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Aynı işletme, farklı zamanlarda ve farklı yatırım projelerinde her iki destekten de yararlanabilir; kısıtlama işletme bazında değil, aynı harcama kaleminin tekrar desteklenmesi bazındadır. Ancak her başvurunun kendi uygunluk kriterlerini ayrı ayrı karşılaması gerekir."}},{"@type":"Question","name":"KOSGEB Girişimci Destek Programı ile Kapasite Geliştirme Destek Programı'nı aynı anda kullanabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"İki program farklı işletme profillerine (yeni kuruluş ile büyümekte olan işletme) hitap eder ve şartları birbirinden bağımsız değerlendirilir. Hangi programa hangi aşamada uygun olduğunuzu, güncel uygulama esaslarına göre netleştirmek gerekir."}}]}) }}
      />
    </BlogLayout>
  );
}
