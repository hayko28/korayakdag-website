  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Marka değerlemesi ile şirket değerlemesi aynı raporda mı yapılır?","acceptedAnswer":{"@type":"Answer","text":"Bazen evet, bazen hayır. Bir M&A işleminde şirket değerlemesi yapılırken markanın payı ayrı bir kalem olarak aynı sürecin içinde raporlanabilir. Ancak marka lisanslaması, franchise veya kredi teminatı gibi durumlarda, şirketin tamamı değil yalnızca markası değerlendirildiği için bağımsız bir marka değerleme raporu yeterlidir."}},{"@type":"Question","name":"Markam tescilli değilse yine de değerlemesi yapılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Teknik olarak yapılabilir, ancak ISO 10668'in şart koştuğu hukuki analiz zayıf çıkacağı için değerleme sonucu önemli ölçüde risk indirimiyle raporlanır. Tescilsiz bir marka, başkası tarafından kullanılmaya veya tescillenmeye açık olduğu için değerleme açısından güvenilir bir zemin sunmaz; öncelikle tescil sürecinin tamamlanması önerilir."}},{"@type":"Question","name":"Kendi yarattığım markamı neden bilançoma yazamıyorum?","acceptedAnswer":{"@type":"Answer","text":"TMS 38 gereği, işletme içinde zaman içinde yaratılan markalar için harcanan pazarlama ve tanıtım giderleri, işletmenin genel faaliyet maliyetinden güvenilir şekilde ayrıştırılamadığı için maddi olmayan duran varlık olarak muhasebeleştirilemez. Marka değeri bilançoya ancak satın alma veya işletme birleşmesi yoluyla edinildiğinde girebilir."}},{"@type":"Question","name":"Royalty relief yöntemi tam olarak nasıl çalışır?","acceptedAnswer":{"@type":"Answer","text":"Bu yöntem, markanızı kullanmasaydınız ve onu üçüncü bir taraftan lisanslamak zorunda kalsaydınız ödeyeceğiniz varsayımsal royalti bedelini hesaplar. Markayla ilişkili gelecekteki ciroya sektör emsallerine uygun bir royalti oranı uygulanır, bu tutarların bugünkü değerine indirgenmesi markanın parasal değerini verir."}},{"@type":"Question","name":"Marka değerlemesi ne kadar sürede tamamlanır?","acceptedAnswer":{"@type":"Answer","text":"Süre; markanın tescil kapsamının netliğine, finansal verilerin hazır olup olmamasına ve değerlemenin amacına (basit bir raporlama mı, dava veya M&A gibi daha kapsamlı bir süreç mi) göre değişir. Veriler eksiksiz sağlandığında süreç genellikle birkaç haftalık bir çalışmayla tamamlanabilir."}},{"@type":"Question","name":"Küçük bir işletme için marka değerlemesi yaptırmak mantıklı mı?","acceptedAnswer":{"@type":"Answer","text":"Eğer markanızı lisanslamayı, franchise vermeyi, satmayı veya yakın gelecekte bir yatırımcıyla görüşmeyi planlıyorsanız evet, mantıklıdır. Somut bir işlem beklenmiyorsa, önceliği önce marka tescilini tamamlamaya ve markanın tanınırlığını büyütmeye vermek, değerlemeyi de o zaman daha anlamlı bir rakamla sonuçlandırır."}}]}) }}
      />
    </BlogLayout>
  );
}
