  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Marka tescili şart mı, kullanım yeterli olmaz mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır, yeterli değildir. Türk hukukunda marka üzerindeki münhasır haklar tescil ile doğar. Tescilsiz kullanım, ancak sınırlı ve ispatı zor haksız rekabet hükümleriyle korunmaya çalışılabilir; bu da tescilli markanın sağladığı güvenceyi vermez."}},{"@type":"Question","name":"Marka tescili ortalama ne kadar sürede tamamlanır?","acceptedAnswer":{"@type":"Answer","text":"İtiraz gelmeyen, eksiksiz başvurularda 6-12 ay içinde tescil tamamlanabiliyor. İtiraz süreci işletilirse bu süre 12-18 aya kadar uzayabiliyor."}},{"@type":"Question","name":"Patent ile faydalı model arasında hangisini seçmeliyim?","acceptedAnswer":{"@type":"Answer","text":"Buluşunuz yüksek katma değerli, teknik olarak karmaşık ve uzun vadeli bir rekabet avantajı sağlıyorsa patent; ürün geliştirme döngünüz hızlıysa ve daha kısa sürede koruma almak istiyorsanız faydalı model daha uygun olabilir. Faydalı modelde buluş basamağı aranmadığından süreç daha hızlı ilerler."}},{"@type":"Question","name":"Marka tescilinden önce buluşumu/ürünümü tanıtırsam sorun olur mu?","acceptedAnswer":{"@type":"Answer","text":"Marka için bu durum genellikle sorun yaratmaz; ancak patent başvurusu planlanan bir buluş, başvurudan önce kamuya açık şekilde paylaşılırsa \"yenilik\" şartı zedelenebilir ve patent başvurusu reddedilebilir. Bu nedenle patentlenmesi düşünülen buluşların başvurudan önce kamuya açıklanmaması önemlidir."}},{"@type":"Question","name":"Marka tescilim sadece Türkiye'de mi geçerli?","acceptedAnswer":{"@type":"Answer","text":"Evet. TÜRKPATENT nezdinde alınan tescil yalnızca Türkiye sınırları içinde koruma sağlar. Yurt dışında da koruma istiyorsanız Madrid Protokolü kapsamında uluslararası başvuru yapmanız veya hedef ülkede doğrudan yerel başvuru yapmanız gerekir."}},{"@type":"Question","name":"KOBİ'ler marka/patent maliyetleri için destek alabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Uygun projelerde TÜBİTAK ve KOSGEB Ar-Ge destek programları patent süreciyle ilgili bazı giderleri destekleyebilir; ayrıca ihracatçılar için Ticaret Bakanlığı'nın yurt dışı marka tescili destek kalemi mevcuttur. Şirketinizin somut durumuna uygun destek programının belirlenmesi için profesyonel danışmanlık almanız önerilir."}}]}) }}
      />
    </BlogLayout>
  );
}
