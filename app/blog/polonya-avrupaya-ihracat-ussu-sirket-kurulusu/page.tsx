  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Polonya'da şirket kurmadan da AB'ye ihracat yapabiliyorum. Üs kurmanın gerçek faydası ne?","acceptedAnswer":{"@type":"Answer","text":"Üç somut fayda vardır. Birincisi teslim süresi: stok Avrupa'da olduğu için müşteri günler içinde mal alır. İkincisi ticari algı: Avrupalı alıcı, AB KDV numarası olan bir tedarikçiden alım yapmayı ithalat prosedürüne göre çok daha kolay bulur. Üçüncüsü ise ihaleler ve büyük zincirlerdir; birçoğu AB içinde yerleşik tedarikçi şartı arar."}},{"@type":"Question","name":"A.TR belgesi ile gönderdiğim mal için Polonya'da hiç vergi ödemeyecek miyim?","acceptedAnswer":{"@type":"Answer","text":"A.TR, Gümrük Birliği kapsamındaki ürünlerde gümrük vergisini sıfırlar ancak ithalat KDV'sini ortadan kaldırmaz. Polonya standart KDV oranı %23'tür. KDV Kanunu'nun 33a maddesi kapsamındaki usule geçerseniz bu tutarı gümrükte nakden ödemez, beyannamede mahsuplaşırsınız."}},{"@type":"Question","name":"Polonya deposundaki malı Almanya'daki müşteriye satarken hangi KDV oranını uygularım?","acceptedAnswer":{"@type":"Answer","text":"Alıcı Almanya'da KDV mükellefiyse ve numarası VIES'te aktifse, malın Polonya'dan çıktığını belgelemeniz kaydıyla %0 oran uygulanır. Alıcı nihai tüketici ise mesafeli satış kuralları devreye girer ve 10.000 Euro eşiği aşıldığında OSS üzerinden Almanya'nın KDV oranıyla beyan edilir."}},{"@type":"Question","name":"Estonya usulü CIT'e geçebilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'deki tüzel kişi şirketinizin doğrudan iştiraki olarak kurduğunuz bir Polonya şirketi bu rejimden yararlanamaz; ortakların yalnızca gerçek kişilerden oluşması şarttır. Ayrıca en az 3 kişilik istihdam ve pasif gelirlerin toplam gelirin %50'sini aşmaması koşulları da aranır. Ortaklık yapısı kararı kuruluş aşamasında verilmelidir."}},{"@type":"Question","name":"Depo kiramı Türkiye'den geri alabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Evet, 5973 sayılı Karar kapsamındaki yurt dışı birim kira desteği depoyu da kapsar. Temel destek oranı %50 olup hedef ülke uygulamasıyla artabilir; yıllık üst limitler ve süre Bakanlıkça her yıl güncellenir. Başvurunun süresi içinde ve İhracatçı Birlikleri üzerinden Destek Yönetim Sistemi (DYS) ile yapılması gerekir."}},{"@type":"Question","name":"Polonya'da personel istihdam etmek zorunda mıyım?","acceptedAnswer":{"@type":"Answer","text":"Hukuken zorunlu değildir; şirket dışarıdan hizmet alarak da işletilebilir. Ancak fiili bir ekonomik varlık bulunmaması, transfer fiyatlandırması ve iş yeri (permanent establishment) tartışmalarında aleyhinize kullanılabilir. Gerçek bir üs kuruyorsanız en az bir operasyon sorumlusu ve bir satış sorumlusu ile başlamak hem ticari hem vergisel açıdan daha sağlıklıdır."}}]}) }}
      />
    </BlogLayout>
  );
}
