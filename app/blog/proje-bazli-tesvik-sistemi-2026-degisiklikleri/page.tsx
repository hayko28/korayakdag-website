  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"11572 sayılı Karar ne zaman yürürlüğe girdi?","acceptedAnswer":{"@type":"Answer","text":"9 Ağustos 2026 tarihli ve 33335 sayılı Resmî Gazete'de yayımlanarak yürürlüğe girdi. Bazı raporlama hükümleri için geçmişe dönük geçerlilik esasları da öngörülmüştür; bu nedenle mevcut destek kararı sahiplerinin durumlarını Bakanlıkla teyit etmesi önerilir."}},{"@type":"Question","name":"KOBİ ölçeğindeki bir şirket Proje Bazlı Teşvik Sistemi'ne başvurabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Sistem, asgari 2 milyar TL (Teknoloji Hamlesi Programı'nda 100 milyon TL) sabit yatırım tutarı öngören projelere açıktır. Bu eşiklerin altındaki yatırımlar için genel Yatırım Teşvik Belgesi sistemi, bölgesel ve sektörel destek unsurlarıyla daha uygun bir seçenektir."}},{"@type":"Question","name":"Fizibilite raporunu artık kim hazırlayabilir?","acceptedAnswer":{"@type":"Answer","text":"Yeni düzenlemeye göre fizibilite raporu, Sanayi ve Teknoloji Bakanlığı ile protokol imzalamış kalkınma ve yatırım bankaları tarafından hazırlanmalıdır. Başvuru öncesinde hangi bankaların bu protokole sahip olduğunu teyit etmek gerekir."}},{"@type":"Question","name":"Tamamlama vizesi aldıktan sonra yükümlülüklerim biter mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. 11572 sayılı Karar ile tamamlama vizesi sonrası 5 yıl boyunca yıllık faaliyet raporu sunma zorunluluğu getirildi. Bu raporlarda destek unsurlarının kullanımına ilişkin bilgilerin de yer alması gerekiyor."}},{"@type":"Question","name":"Yatırım Projesi Sözleşmesi kimler için geçerli?","acceptedAnswer":{"@type":"Answer","text":"Asgari 5 milyar TL yatırım tutarına sahip, doğrudan yabancı yatırımcılar veya tamamı yabancı sermayeli iştirakler bu özel hukuk sözleşmesini Bakanlıkla imzalayabilir."}},{"@type":"Question","name":"Proje Bazlı Teşvik Sistemi ile Teknoloji Hamlesi Programı aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır, ama iç içe geçmiş durumdalar. Teknoloji Hamlesi Programı (eski adıyla Teknoloji Odaklı Sanayi Hamlesi Programı), öncelikli ürünlere yönelik yatırımlarda daha düşük bir asgari tutarla (100 milyon TL) Proje Bazlı Teşvik Sistemi'nden yararlanılmasını sağlayan özel bir çağrı mekanizmasıdır. Diğer tüm yatırımlarda asgari tutar 2 milyar TL olarak uygulanmaya devam ediyor."}}]}) }}
      />
    </BlogLayout>
  );
}
