  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"1. Yeni başlayan bir girişimci için hangi şirket türü daha mantıklı?","acceptedAnswer":{"@type":"Answer","text":"Tek kişilik, düşük riskli ve sermaye ihtiyacı sınırlı işler için şahıs şirketi hızlı ve düşük maliyetli bir başlangıç sunar. Birden fazla ortak, sınırlı sorumluluk veya kurumsal müşteri beklentisi varsa limited şirket genellikle daha dengeli bir seçimdir."}},{"@type":"Question","name":"2. Limited şirket ortakları hiçbir borçtan sorumlu değil mi?","acceptedAnswer":{"@type":"Answer","text":"Ticari borçlarda sorumluluk esas olarak sermaye payıyla sınırlıdır. Ancak şirketten tahsil edilemeyen vergi ve SGK prim borçlarında, kanuni temsilciler ve ortaklar belirli şartlarda sermaye payları oranında sorumlu tutulabilir."}},{"@type":"Question","name":"3. Anonim şirket kurmak için neden 250.000 TL sermaye gerekiyor?","acceptedAnswer":{"@type":"Answer","text":"Bu tutar, 1 Ocak 2024'ten itibaren TTK çerçevesinde Cumhurbaşkanı Kararı ile belirlenen asgari sermaye şartıdır. Sermayenin tamamının nakit olarak hazır bulundurulması gerekmez; ancak en az dörtte birinin tescilden önce bankaya yatırılıp bloke edilmesi zorunludur."}},{"@type":"Question","name":"4. Şahıs şirketimi limited şirkete çevirmem ne zaman mantıklı olur?","acceptedAnswer":{"@type":"Answer","text":"Kazancınız gelir vergisi tarifesinde yüksek dilimlere yaklaştığında, kurumsal müşteri/ihale süreçleri sermaye şirketi istediğinde veya sorumluluğunuzu sınırlamak öncelik haline geldiğinde nevi değişikliğini değerlendirmenizi öneririz."}},{"@type":"Question","name":"5. Yatırımcı almayı planlıyorsam hangi türü kurmalıyım?","acceptedAnswer":{"@type":"Answer","text":"Kurumsal yatırımcı, melek yatırımcı ağı veya girişim sermayesi fonlarıyla çalışmayı planlayan girişimler için anonim şirket yapısı, pay devrinin görece kolay olması nedeniyle genellikle daha uygundur. Erken aşamada limited şirketle başlayıp yatırım öncesinde anonime dönüşmek de sık kullanılan bir yoldur."}},{"@type":"Question","name":"6. Kâr payı stopajı hangi şirket türlerinde uygulanır?","acceptedAnswer":{"@type":"Answer","text":"Kâr payı stopajı yalnızca limited ve anonim gibi kurumlar vergisi mükellefi sermaye şirketlerinde, ortaklara kâr dağıtımı yapıldığında uygulanır. 2026 itibarıyla bu oran %15'tir. Şahıs şirketinde ayrı bir kâr dağıtım stopajı yoktur."}},{"@type":"Question","name":"7. Genç girişimci istisnası hangi şirket türünde geçerli?","acceptedAnswer":{"@type":"Answer","text":"Genç girişimci kazanç istisnası, gerçek usulde gelir vergisi mükellefiyeti açan şahıs şirketleri için geçerlidir; limited veya anonim şirket ortaklığı bu istisna kapsamına girmez."}}]}) }}
      />
    </BlogLayout>
  );
}
