  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Bir işveren aynı anda birden fazla SGK teşvikinden yararlanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"İşletme düzeyinde evet, farklı çalışanlar için farklı teşviklerden yararlanılabilir. Ancak aynı sigortalı için genellikle sadece bir teşvik seçilebilir; bazı teşvikler (örneğin Ar-Ge personeli teşviki) genel indirimle katmanlı çalışırken bazıları (06111 gibi) genel indirimle birlikte uygulanamaz."}},{"@type":"Question","name":"SGK teşvikinden yararlanmak için ayrı bir başvuru formu doldurmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Genel prim indirimi ve asgari ücret desteği gibi bazı teşvikler otomatik hesaplanır. Diğerlerinde ise ayrı bir \"başvuru formu\" yerine, Muhtasar ve Prim Hizmet Beyannamesi'nde doğru kanun numarasının seçilmesi ve (varsa) ilgili belgenin sisteme tanımlanması gerekir."}},{"@type":"Question","name":"Teşvik şartları ihlal edilirse ne olur?","acceptedAnswer":{"@type":"Answer","text":"Şartın bozulduğu ay için teşvik uygulanmaz; kayıt dışı istihdam veya sahte bildirim tespit edilirse yararlanılan tutar geriye dönük olarak gecikme cezasıyla birlikte geri alınabilir."}},{"@type":"Question","name":"27103/17103 sayılı ilave istihdam teşviki hâlâ geçerli mi?","acceptedAnswer":{"@type":"Answer","text":"Yeni işe alımlar için hayır; bu teşvik 31 Aralık 2022'den sonra yapılan işe alımları kapsamıyor. Ancak bu tarihten önce hak kazanmış ve şartları sağlamaya devam eden mevcut yararlanıcılar için ödemeler sürebiliyor."}},{"@type":"Question","name":"Küçük bir işletme için en yüksek tasarruf sağlayan teşvik hangisi?","acceptedAnswer":{"@type":"Answer","text":"Bu, işletmenin sektörüne (imalat olup olmadığı), çalışan profiline (genç/kadın/engelli/mesleki belge sahibi olup olmadığı) ve yatırım/Ar-Ge faaliyeti olup olmadığına göre değişir. Genel prim indirimi neredeyse tüm işverenler için geçerliyken, 06111 ve engelli teşviki gibi teşvikler belirli profildeki çalışanlar için çok daha yüksek bir tasarruf sağlar. Şirketinize özel en avantajlı kombinasyonu görmek için bordro verileriniz üzerinden hesaplama yapılması gerekir."}}]}) }}
      />
    </BlogLayout>
  );
}
