...
export default function BlogPage() {
  return (
    <BlogLayout
      ...
      ctaHeading="Singapur'da Şirket Kuruluşu İçin Destek Alın"
      ctaText="Pte Ltd kuruluşu, yerel direktör şartı, ACRA kaydı ve Asya pazarına açılma kurgusu. Singapur'da yapılanma sürecinizi baştan sona yönetiyoruz."
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Singapur'da şirket kurmak için ülkede fiziken bulunmam gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Tescil başvurusu BizFile+ üzerinden vekâletle ve tamamen dijital olarak tamamlanabilir. Ancak en az bir Singapur ikametli direktör (nominee director hizmeti dahil) şartı sağlanmalı, banka hesabı açılışı için de bankanın politikasına göre bir yetkilinin fiziken bulunması gerekebilir."}},{"@type":"Question","name":"Nominee director şirketin yönetimine karışabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Nominee director yalnızca yasal ikamet şartını karşılamak için atanır; operasyonel kararlar, banka yetkileri ve hissedarlık hakları tamamen gerçek ortaklarda kalır. Bu düzenleme, taraflar arasında imzalanan hizmet ve ibra sözleşmesiyle güvence altına alınır."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Belgeler eksiksiz olduğunda ACRA/BizFile üzerinden tescil genellikle 1-3 iş günü içinde tamamlanır. İsim başvurusu başka bir düzenleyici kuruma yönlendirilirse bu süre 14-60 güne kadar uzayabilir; banka hesabı açılışı ayrıca 1-8 hafta sürebilir."}},{"@type":"Question","name":"GST'ye ne zaman kayıt olmam gerekir?","acceptedAnswer":{"@type":"Answer","text":"Yıllık cironuz geçmiş 12 ayda 1.000.000 SGD'yi aşarsa veya önümüzdeki 12 ayda aşacağı öngörülüyorsa, eşiğin aşılmasından itibaren 30 gün içinde IRAS nezdinde GST kaydınızı yaptırmanız zorunludur. Bu eşiğin altındaki şirketler için kayıt ihtiyaridir."}},{"@type":"Question","name":"Singapur'da kurulan şirketin Türkiye'de de vergi yükümlülüğü olur mu?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de yerleşik gerçek veya tüzel kişilerin Singapur'daki şirketten elde ettiği kazançlar Türkiye'de de beyan yükümlülüğüne tabi olabilir. Türkiye-Singapur Çifte Vergilendirmeyi Önleme Anlaşması kapsamında Singapur'da ödenen verginin Türkiye'de mahsubu mümkün olabilir; detaylar somut duruma göre değerlendirilmelidir."}}]}) }}
      />
    </BlogLayout>
  );
}
