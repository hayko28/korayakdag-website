  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Şirket değerleme raporu kaç günde hazırlanır?","acceptedAnswer":{"@type":"Answer","text":"Süre; şirketin büyüklüğüne, finansal kayıtların düzenine ve değerlemenin amacına göre değişir. Veri ve belgelerin eksiksiz sağlandığı orta ölçekli bir KOBİ için süreç genellikle birkaç haftayı bulur; karmaşık yapıya sahip veya birden fazla iştiraki olan şirketlerde bu süre uzayabilir."}},{"@type":"Question","name":"KOBİ'ler için hangi değerleme yöntemi \"en doğru\" yöntemdir?","acceptedAnswer":{"@type":"Answer","text":"Tek bir \"en doğru\" yöntem yoktur. Uygulamada, şirketin yapısına göre genellikle birden fazla yöntem bir arada kullanılır ve sonuçlar çapraz kontrol edilerek makul bir değer aralığına ulaşılır."}},{"@type":"Question","name":"Değerleme raporu hukuken bağlayıcı mıdır?","acceptedAnswer":{"@type":"Answer","text":"Değerleme raporu, taraflar arasındaki müzakereye veya hukuki sürece nesnel bir referans sunar; ancak nihai fiyat veya karar, tarafların kendi aralarındaki anlaşmasına ya da (dava süreçlerinde) mahkemenin değerlendirmesine bağlıdır."}},{"@type":"Question","name":"Aynı şirket için farklı zamanlarda yapılan değerlemeler neden farklı sonuç verebilir?","acceptedAnswer":{"@type":"Answer","text":"Değerleme; güncel finansal performansa, piyasa koşullarına, faiz oranlarına ve sektörün genel görünümüne dayanır. Bu girdiler zaman içinde değiştiği için, aynı şirketin farklı tarihlerdeki değeri de doğal olarak farklılaşır."}},{"@type":"Question","name":"Şirket sahibinin kendi hesapladığı değer neden genelde farklı çıkıyor?","acceptedAnswer":{"@type":"Answer","text":"Şirket sahipleri genellikle tek bir basit çarpan kullanır ve şirkete duygusal bağları nedeniyle değeri yüksek tahmin etme eğilimindedir; ayrıca finansal tabloları normalize etmeden değerlendirdikleri için gerçek operasyonel kârlılığı net göremezler."}},{"@type":"Question","name":"Değerleme sadece satış öncesinde mi gerekir?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Ortaklık değişikliği, yatırımcı görüşmesi, miras paylaşımı, kredi süreci, dava/anlaşmazlık ve stratejik karar alma gibi birçok farklı durumda da değerleme ihtiyacı doğar."}}]}) }}
      />
    </BlogLayout>
  );
}
