  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Ortak girişim (JV) kurmak için mutlaka yeni bir şirket mi kurmam gerekiyor?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Şirket kurmak yaygın bir yöntem olsa da, tek işlem zorunlu değil. Kısa/orta vadeli veya tek bir projeye özgü ortaklıklar, Türk Borçlar Kanunu'nun adi ortaklık hükümlerine (m.620 vd.) dayanan sözleşmesel bir yapıyla, hiç yeni şirket kurmadan da yürütülebilir."}},{"@type":"Question","name":"Her ortak girişim Rekabet Kurulu'na bildirilmek zorunda mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Bildirim yükümlülüğü, ortak girişimin \"tam işlevsel\" olması ve tarafların cirolarının 2026/2 sayılı Tebliğ'deki eşikleri (toplamda 3 milyar TL, en az iki tarafta ayrı ayrı 1 milyar TL Türkiye cirosu, teknoloji teşebbüslerinde 250 milyon TL) aşmasına bağlı. Küçük ve orta ölçekli çoğu ortaklık bu eşiklerin altında kalır."}},{"@type":"Question","name":"Stratejik iş ortaklığından ortak girişime nasıl geçilir?","acceptedAnswer":{"@type":"Answer","text":"Genellikle taraflar önce daha esnek bir sözleşmesel iş birliğiyle (örneğin ortak pazarlama veya distribütörlük anlaşmasıyla) başlar; işbirliği olgunlaştıkça ve karşılıklı güven arttıkça sermaye birleştirerek ortak bir şirket kurma kararı alınabilir. Bu geçiş, başlangıçtaki sözleşmede bir \"ortaklığa dönüştürme\" opsiyonu olarak da baştan planlanabilir."}},{"@type":"Question","name":"Yabancı bir şirketle ortak girişim kurarken ayrı bir yabancı sermaye izni almam gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Genel kural olarak hayır. 4875 sayılı Doğrudan Yabancı Yatırımlar Kanunu, yabancı yatırımcıya Türk yatırımcıyla eşit muamele ilkesini getirir ve şirket kuruluşu için ayrı bir izin şartı aramaz. Ancak bankacılık, sigortacılık, enerji gibi düzenlenmiş sektörlerde faaliyet gösterilecekse, ilgili düzenleyici kurumdan sektörel izin alınması ayrı bir zorunluluktur."}},{"@type":"Question","name":"Ortak girişim ile konsorsiyum arasındaki fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Klasik ortak girişimde taraflar işin tamamından müştereken sorumludur ve kâr/zarar birlikte paylaşılır. Konsorsiyumda ise her ortak, üstlendiği işin belirli bir bölümünden ayrı ayrı sorumludur; müteselsil sorumluluk sözleşmeyle sınırlandırılır. Kamu ihaleleri ve büyük altyapı projelerinde iş net biçimde bölünmek istendiğinde konsorsiyum modeli tercih edilir."}},{"@type":"Question","name":"Ortaklık sözleşmesinde \"çıkış hükmü\" olmazsa ne olur?","acceptedAnswer":{"@type":"Answer","text":"Çıkış senaryosu tanımlanmamışsa, bir ortağın ayrılmak istediği durumda payının nasıl değerleneceği ve devrin nasıl gerçekleşeceği belirsiz kalır. Bu genellikle taraflar arasında uzun süren ihtilaflara, hatta şirketin fiilen yönetilemez hâle gelmesine yol açar. Bu yüzden çıkış hükümleri (değerleme yöntemi, önalım hakkı, sürükleme/birlikte satış hakları) sözleşmenin kuruluş aşamasında mutlaka yazılmalıdır."}}]}) }}
      />
    </BlogLayout>
  );
}
