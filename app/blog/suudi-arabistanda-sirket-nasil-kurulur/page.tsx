...
export default function BlogPage() {
  return (
    <BlogLayout
      ...
      ctaHeading="Suudi Arabistan'da Şirket Kuruluşu İçin Destek Alın"
      ctaText="MISA yatırım lisansı, LLC kuruluşu, sermaye şartları ve Vizyon 2030 kapsamındaki sektörel fırsatlar. Suudi Arabistan'da yapılanma sürecinizi baştan sona yönetiyoruz."
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Suudi Arabistan'da şirket kurmak için ülkede ikamet etmek gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"MISA lisansı ve ticaret sicili başvurusu vekâletle uzaktan yürütülebilir. Ancak banka hesabı açılışı için genel müdür veya yetkili imza sahibinin Nafath doğrulaması amacıyla fiziken ülkede bulunması ve ikamet izni (Iqama) alması gerekir."}},{"@type":"Question","name":"Kurumlar vergisi mi öderim, Zekat mı?","acceptedAnswer":{"@type":"Answer","text":"Bu, ortaklık yapınıza bağlıdır. Şirketin Suudi/GCC vatandaşı ortaklara ait payı Zekat (%2,5) kapsamında değerlendirilirken, yabancı (Türk) ortaklara ait pay %20 kurumlar vergisine tabidir. %100 yabancı sermayeli bir şirket sadece kurumlar vergisi öder."}},{"@type":"Question","name":"LLC mi kurmalıyım, şube mi açmalıyım?","acceptedAnswer":{"@type":"Answer","text":"Ticaret, üretim veya geniş kapsamlı hizmet faaliyeti planlayan, sorumluluğunu sınırlı tutmak isteyen firmalar için LLC daha uygundur. Sadece belirli bir proje veya temsil faaliyeti yürütecek, ana şirketle sıkı bağlantılı yapılar için şube tercih edilebilir."}},{"@type":"Question","name":"Bölgesel Merkez (RHQ) programından kimler yararlanabilir?","acceptedAnswer":{"@type":"Answer","text":"RHQ programı, MENA bölgesindeki operasyonlarını yöneten çok uluslu şirket grupları için tasarlanmıştır ve 30 yıl %0 kurumlar vergisi imkânı sunar. İlk kez pazara girecek KOBİ ölçekli firmalar için bu program pratikte uygulanabilir değildir; standart LLC yapısı bu profildeki firmalar için daha uygundur."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"MISA lisansı, dosya eksiksizse birkaç gün içinde onaylanabilir. Ticaret sicili ve diğer kurumsal kayıtlarla birlikte toplam süreç genellikle 3-6 hafta sürer; banka hesabı açılışı ve ikamet izni süreçleri buna ek zaman gerektirebilir."}}]}) }}
      />
    </BlogLayout>
  );
}
