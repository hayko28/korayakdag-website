  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Tam tasdik yaptırmak zorunlu mu?","acceptedAnswer":{"@type":"Answer","text":"Genel kural olarak hayır, tam tasdik ihtiyaridir. Ancak 2026'dan itibaren belirli istisna ve indirim kalemleri (tek kalemde 500.000 TL, toplamda 1.000.000 TL sınırını aşan durumlarda) için YMM tasdik raporu ibrazı zorunlu hale getirildi. Şirketin zaten süresinde yapılmış bir tam tasdik sözleşmesi varsa, bu kalemler için ayrıca rapor almasına gerek kalmıyor; bu da fiilen tam tasdiki bu profildeki şirketler için pratikte kaçınılmaz bir tercih hâline getiriyor."}},{"@type":"Question","name":"Tam tasdik sözleşmesi ne zaman imzalanmalı?","acceptedAnswer":{"@type":"Answer","text":"Süresinde sayılması için, takvim yılına tabi mükelleflerde hesap döneminin ilk ayı içinde, yani en geç 31 Ocak'a kadar imzalanması gerekir. Yıl içinde işe başlayan veya önceki sözleşmesi sona eren mükellefler ise ilgili tarihten itibaren bir ay içinde yeni sözleşme yapabilir."}},{"@type":"Question","name":"Tam tasdik ile bağımsız denetim aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Bağımsız denetim, KGK tarafından belirlenen büyüklük eşiklerini aşan şirketlerin finansal tablolarının bağımsız denetçi tarafından denetlenmesidir ve belirli şirketler için zorunludur. Tam tasdik ise vergi beyannamesi ve mali tabloların YMM tarafından tasdikidir; ihtiyaridir ve farklı bir amaca hizmet eder. Bir şirket her iki hizmete de aynı anda tabi olabilir."}},{"@type":"Question","name":"Tam tasdik sözleşmesi yıl ortasında feshedilebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet, sözleşme taraflardan biri tarafından feshedilebilir; ancak fesih durumunda mükellefin beyannamelerini tasdik ettirmeye devam etmek istemesi hâlinde, fesih tarihinden itibaren bir ay içinde yeni bir YMM ile sözleşme yapması gerekir. Fesih ve yeni sözleşme bilgilerinin de süresinde İnternet Vergi Dairesi'ne bildirilmesi önemlidir."}},{"@type":"Question","name":"Tam tasdik yaptıran şirket hiç vergi incelemesine alınmaz mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır, bu bir garanti değildir. Tam tasdik, beyannamenin önceden bağımsız bir uzman tarafından incelenmiş olması nedeniyle inceleme önceliğini ve riskini azaltır; ancak ihbar, karşıt inceleme bulgusu veya sektörel/riskli işlem taraması gibi özel durumlarda inceleme yine de yapılabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
