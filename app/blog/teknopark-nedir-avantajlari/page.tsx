  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"1. Firma, mevcut teknoloji şirketiyle teknoparka girebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Teknoparka girmek için her durumda yeni bir şirket kurulması gerekmez. Mevcut teknoloji şirketi, faaliyetlerinin uygun olması halinde yeni bir şube açarak teknopark yapılanmasına dahil olabilir ve mevcut personellerini de bu yapıya aktarabilir."}},{"@type":"Question","name":"2. Teknoparkta firmaya özel bağımsız ofis kiralanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Teknoparklarda yalnızca ortak çalışma alanları bulunmaz. Firmaya özel, bağımsız kapısı olan ve şirketin kendi çalışanlarına tahsis edilen Ar-Ge ofisleri de bulunabilir."}},{"@type":"Question","name":"3. Teknoparkta yeni şirket kurulduğunda ofise girme mecburiyeti var mı?","acceptedAnswer":{"@type":"Answer","text":"Çalışanların niteliğine ve ilgili çalışma kurallarına göre uzaktan çalışma mümkündür. Bilişim mezuniyetine sahip uygun personeller %100 uzaktan çalışabilirken, bu kapsamda olmayan personellerin aylık toplam çalışma süresinin %25'ini teknopark içerisinde geçirmesi gerekir."}},{"@type":"Question","name":"4. Teknoparkta 100.000 dolar ciro yapan şirket bütün satışlarını KDV'siz mi keser?","acceptedAnswer":{"@type":"Answer","text":"Hayır. KDV istisnası şirketin tüm cirosuna otomatik olarak uygulanmaz. Şartları sağlayan uygun faaliyetlerden elde edilen gelirlere uygulanır. Yazılım lisans satışı, uygun yazılım geliştirme faaliyetleri ve mevzuatta belirtilen teslim ve hizmetler bu kapsamda değerlendirilebilir."}},{"@type":"Question","name":"5. KDV istisnasında ciro sınırı var mı?","acceptedAnswer":{"@type":"Answer","text":"Değerlendirme yalnızca ciro büyüklüğü üzerinden yapılmaz. Esas olarak gelirin hangi faaliyetten elde edildiği ve ilgili KDV istisnası şartlarının sağlanıp sağlanmadığı önemlidir."}},{"@type":"Question","name":"6. Teknoparka girmek için minimum kaç çalışan gerekir?","acceptedAnswer":{"@type":"Answer","text":"Teknoparka başvuru açısından genel bir minimum personel zorunluluğu bulunmadığı belirtilmektedir. Bir kişiyle dahi başvuru yapılabilmesi küçük girişimler için önemli bir avantajdır."}},{"@type":"Question","name":"7. Yazılım şirketleri teknoparka girebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Yazılım şirketleri teknopark ekosisteminin en önemli kullanıcı gruplarından biridir. Ancak geliştirilen faaliyet veya projenin teknopark mevzuatı kapsamında uygun nitelikte olması gerekir."}},{"@type":"Question","name":"8. Kollektif şirket teknoparka girebilir mi?","acceptedAnswer":{"@type":"Answer","text":"Kollektif şirket yapısı da teknopark açısından değerlendirilebilecek alternatiflerden biridir. Ancak yönetici şirketin kabul kriterleri ve şirketin proje/faaliyet yapısı ayrıca değerlendirilmelidir."}},{"@type":"Question","name":"9. Teknoparkta sadece ortak çalışma alanı mı kiralanabilir?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Teknoparklarda firmaya özel bağımsız Ar-Ge ofisleri de bulunabilir. Şirket ihtiyacına göre özel ofis tercih edilebilir."}},{"@type":"Question","name":"10. Teknopark ile Ar-Ge Merkezi arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Teknoparklarda genel minimum personel şartı bulunmaz ve özellikle yazılım şirketleri açısından satış, KDV ve diğer teşvik mekanizmaları önem taşır. Ar-Ge Merkezlerinde ise personel sayısı, Ar-Ge yapılanması ve kurumsal kriterler daha farklıdır."}}]}) }}
      />
    </BlogLayout>
  );
}