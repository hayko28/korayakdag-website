  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Bayilik sözleşmesi ile distribütörlük sözleşmesi arasındaki temel fark nedir?","acceptedAnswer":{"@type":"Answer","text":"İkisi de kendi adına ve hesabına satış yapan bağımsız tacir ilişkisidir; asıl fark ölçekte ortaya çıkar. Distribütör genellikle daha geniş bir bölgeyi (ülke veya çoklu il) kapsar, çoğu zaman ithalat/depolama yetkisi taşır ve kendi altında bir bayi ağı kurabilir. Bayi ise daha çok yerel/bölgesel ölçekte, distribütörün veya üreticinin altında satış yapan taraftır."}},{"@type":"Question","name":"Bayilik sözleşmesi feshedildiğinde bayi her zaman tazminat alabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Denkleştirme tazminatı otomatik doğmaz; bayinin tedarikçiye yeni müşteri kazandırmış olması, tedarikçinin sözleşme bittikten sonra da bu portföyden önemli menfaat elde etmeye devam etmesi ve tazminatın somut olayda hakkaniyete uygun düşmesi gibi şartların birlikte gerçekleşmesi gerekir. Ayrıca bu tazminat, TTK m.122/2 uyarınca son beş yıllık ortalama yıllık kazançla sınırlıdır."}},{"@type":"Question","name":"Cezai şart maddesi çok yüksek yazılırsa geçerli olur mu?","acceptedAnswer":{"@type":"Answer","text":"Taraflar ceza tutarını serbestçe belirleyebilir, ancak TBK m.182 uyarınca hâkim, aşırı bulduğu bir ceza koşulunu kendiliğinden indirebilir. Bu nedenle cezai şart tutarının, tarafların gerçek zarar potansiyeliyle makul bir orantı içinde belirlenmesi, maddenin uygulanabilirliğini güçlendirir."}},{"@type":"Question","name":"Distribütörün belirli bir bölgeye satış yapmasını tamamen yasaklayabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Aktif satış kısıtlamaları (o bölgeye yönelik doğrudan pazarlama/reklam yapmama) belirli şartlarda mümkündür. Ancak pasif satışların, yani bölge dışından kendiliğinden gelen bir siparişin karşılanmasının tamamen engellenmesi, Rekabet Kurumu'nun dikey anlaşmalar mevzuatı açısından risklidir ve grup muafiyetinden yararlanmayı tehlikeye atabilir."}},{"@type":"Question","name":"Sözleşme sonrası rekabet yasağı süresiz olarak yazılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Önerilmez. Süresiz veya aşırı uzun tutulan rekabet yasakları, hem TBK'nın genel ilkeleri hem de dikey anlaşmalar mevzuatı açısından geçersiz sayılma veya hâkim tarafından daraltılma riski taşır. Yasağın süre, yer ve konu bakımından makul ve sınırlı tutulması gerekir."}},{"@type":"Question","name":"Yurt dışındaki bir tedarikçiyle yapılan sözleşmede hangi ülkenin mahkemesi yetkili olur?","acceptedAnswer":{"@type":"Answer","text":"Bu, taraflarca sözleşmede açıkça kararlaştırılması gereken bir konudur. Sözleşmede yetkili mahkeme veya tahkim maddesi ile uygulanacak hukuk maddesi yazılmazsa, hangi ülke hukukunun ve hangi merciin uygulanacağı ayrı bir hukuki uyuşmazlık konusu haline gelebilir; bu nedenle bu maddelerin sözleşme imzalanmadan önce netleştirilmesi önemlidir."}}]}) }}
      />
    </BlogLayout>
  );
}
