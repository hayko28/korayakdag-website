  ...
  return (
    ...
    >
        ...
        <section className="mt-24 scroll-mt-24">
          <div className="rounded-2xl border-l-4 border-orange-500 bg-orange-50 p-8">
            <h3 className="mb-4 text-2xl font-bold text-[#071A2F]">
              🤝 TSRS Kapsam Analizi ve Raporlama Hazırlığında Destek
            </h3>
            <p className="leading-8 text-gray-700">
              Şirketinizin yeni eşik değerlere göre TSRS kapsamına girip
              girmediğini netleştirmek, güvence denetimi takvimini doğru
              planlamak ve raporlama altyapısını zamanında kurmak,
              ilerleyen dönemde zaman baskısı ve uyum riskini önler.{" "}
              <Link href="/#contact" className="text-orange-600 underline">
                Şirketinizin TSRS kapsam durumunu değerlendirmemiz için
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Eşik değerleri neden yükseltildi?","acceptedAnswer":{"@type":"Answer","text":"KGK, 13 Ocak 2026 tarihli Kurul Kararı ile TSRS kapsamını belirleyen aktif toplamı, net satış hasılatı ve çalışan sayısı eşiklerini yeniden belirledi. Karar, 16 Ocak 2026 tarihli ve 33139 sayılı Resmî Gazete'de yayımlandı ve 1 Ocak 2025'te başlayan hesap dönemlerinden itibaren uygulanıyor."}},{"@type":"Question","name":"Şirketim geçen yıl kapsamdaydı, bu yıl da kapsamda mı sayılır?","acceptedAnswer":{"@type":"Answer","text":"Otomatik olarak değil. Kapsam değerlendirmesi her yıl güncel eşiklere göre, art arda iki hesap dönemi esas alınarak yeniden yapılır. Eski eşiklere göre kapsamda olan bir şirket, yeni ve daha yüksek eşikler karşısında kapsam dışına çıkabilir."}},{"@type":"Question","name":"Kapsam dışında kalan bir şirket gönüllü rapor hazırlayabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Zorunluluk kapsamı dışında kalan şirketler de gönüllü olarak TSRS uyumlu rapor hazırlayabilir. Özellikle büyük ölçekli alıcıların tedarikçilerinden sürdürülebilirlik verisi talep ettiği sektörlerde bu, ticari bir avantaja dönüşebilir."}},{"@type":"Question","name":"Güvence denetimini kim yapabilir?","acceptedAnswer":{"@type":"Answer","text":"Sürdürülebilirlik raporlarının güvence denetimi, konuya ilişkin yetkilendirme şartlarını taşıyan bağımsız denetim kuruluşları tarafından yürütülür. 2026 itibarıyla bu denetim ilk aşamada sınırlı güvence seviyesinde gerçekleştirilmektedir."}},{"@type":"Question","name":"Rapor hazırlamamanın bir yaptırımı var mı?","acceptedAnswer":{"@type":"Answer","text":"KGK ve ilgili denetim otoriteleri, kapsamda olduğu hâlde raporlama yükümlülüğünü yerine getirmeyen kuruluşlar için denetim ve yaptırım yetkisine sahiptir. Somut yaptırım süreçleri şirketin statüsüne (halka açık, finans kuruluşu vb.) göre farklılaşabileceğinden, güncel durumun resmî kaynaklardan teyit edilmesi önerilir."}}]}) }}
      />
    </BlogLayout>
  );
}
