...
export const metadata: Metadata = {
  ...
  description: "TÜBİTAK 1711'de şirket-üniversite konsorsiyum şartı, 10 milyon TL bütçe üst sınırı; ön kayıt 28 Eylül, kesin başvuru 2 Ekim 2026'a uzatıldı.",
  keywords: [
    "TÜBİTAK 1711",
...
export default function Tubitak1711Page() {
  return (
    <BlogLayout
      ...
      description="Şirketlerin üniversite veya kamu araştırma kurumlarıyla konsorsiyum kurarak başvurduğu TÜBİTAK 1711 Yapay Zeka Ekosistemi Çağrısı'nda 5 öncelikli alan, 10 milyon TL bütçe üst sınırı, %60-%70 destek oranı; TÜBİTAK'ın uzattığı ön kayıt (28 Eylül) ve kesin başvuru (2 Ekim 2026) tarihleriyle güncel rehber."
    ...
    >
      ...
      <div className="rounded-2xl border-l-4 border-red-500 bg-red-50 p-8">
        <h2 className="mb-4 text-2xl font-bold text-[#071A2F]">
          🔴 Güncelleme: Başvuru Süresi Uzatıldı, Yeni Son Tarih 2 Ekim 2026
        </h2>
        <p className="leading-8 text-gray-700">
          TÜBİTAK, 2022&apos;den bu yana her yıl açtığı{" "}
          <strong>1711 Yapay Zeka Ekosistemi Çağrısı&apos;nın</strong> beşincisini
          15 Haziran 2026&apos;da başvuruya açtı. TÜBİTAK sonradan başvuru
          süresini uzattı: kesin proje başvurusu artık{" "}
          <strong>2 Ekim 2026 saat 23:59&apos;da</strong> kapanacak; ancak
          kuruluş bazlı ön kayıt işleminin <strong>28 Eylül 2026 saat
          23:59&apos;a</strong> kadar tamamlanmış olması gerekiyor. Ön kayıt
          yapmayan kuruluşlar kesin başvuru aşamasına geçemiyor, bu yüzden bu
          iki tarihi karıştırmamak kritik önem taşıyor. Bu çağrının en kritik
          özelliği, şirketlerin tek başına değil, mutlaka bir üniversite veya
          kamu araştırma kurumuyla birlikte konsorsiyum kurarak
          başvurabilmesi. Konsorsiyum kurma ve işbirliği sözleşmesi hazırlama
          süreci zaman aldığından, hazırlığa hemen başlamak gerekiyor.
        </p>
      </div>
      ...
      <section id="dikkat" className="mt-24 scroll-mt-24">
        ...
        <div className="rounded-2xl border border-red-200 bg-red-50 p-8">
          <ul className="ml-6 list-disc space-y-4 text-gray-700 marker:text-red-500">
            ...
            <li>
              Ön kayıt son tarihi (28 Eylül), nihai başvuru tarihinden (2
              Ekim) önce geldiği için bu iki tarih birbirine
              karıştırılmamalıdır; ön kaydını tamamlamayan kuruluş kesin
              başvuru yapamaz.
            </li>
            <li>
      ...
      <section className="mt-24 scroll-mt-24">
        <div className="rounded-2xl border-l-4 border-orange-500 bg-orange-50 p-8">
          ...
          <p className="leading-8 text-gray-700">
            ...
            alandan birine uygun kurgulamak ve 2 Ekim 2026 son başvuru
      ...
      <section id="sonuc" className="mt-24 scroll-mt-24">
        ...
        <p className="text-lg leading-9 text-gray-700">
          TÜBİTAK&apos;ın süre uzatımıyla ön kayıt için 28 Eylül, kesin
          başvuru için 2 Ekim 2026&apos;ya kadar zaman tanınmış olsa da,
          uygun bir üniversite/araştırma kurumu ortağı belirleme, işbirliği
          sözleşmesini hazırlama ve PRODİS ön kaydını tamamlama adımlarına
