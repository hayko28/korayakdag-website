  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"BiGG Yatırım (1812) hibe midir, kredi midir?","acceptedAnswer":{"@type":"Answer","text":"Hiçbiri değildir. TÜBİTAK BiGG Fonu, kurulacak şirketin hissesi karşılığında sermaye yatırımı yapar; girişimci tutarı geri ödemez, ancak şirketin bir payını (standart başvurularda %3'ünü) TÜBİTAK'a devreder."}},{"@type":"Question","name":"Henüz hiçbir hızlandırma programına katılmadım, 2026-2 çağrısına başvurabilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Hayır. 2026-2 çağrısı yalnızca bir uygulayıcı kuruluşun Aşama 1 hızlandırma programını tamamlayıp Mükemmeliyet Mührü almış girişimcilere açıktır. Sıfırdan başlayacaksanız önce bir uygulayıcı kuruluşa başvurup hızlandırma sürecine girmeniz gerekir."}},{"@type":"Question","name":"Şirketimi başvurudan önce kurdum, bu sorun olur mu?","acceptedAnswer":{"@type":"Answer","text":"Olabilir. Program, başvuru anında herhangi bir sermaye şirketinde ortaklık payı bulunmamasını şart koşuyor; erken kurulmuş bir şirketteki ortaklık payı uygunluk şartını ihlal edebilir. Şirket kuruluşunun Mükemmeliyet Mührü alındıktan sonraya bırakılması önerilir."}},{"@type":"Question","name":"1812 ile 1512 (klasik BiGG) arasındaki fark nedir?","acceptedAnswer":{"@type":"Answer","text":"1512, henüz şirketi olmayan girişimcilerin iş fikrini hızlandırma sürecinden geçirip teknogirişim sermayesi desteğine (hibe) dönüştürdüğü programdır. 1812 ise bu sürecin bir sonraki adımıdır: Mükemmeliyet Mührü almış girişimcilere hisse karşılığı sermaye yatırımı sağlar."}},{"@type":"Question","name":"Yatırım karşılığında alınan hisse geri satın alınabilir mi?","acceptedAnswer":{"@type":"Answer","text":"TÜBİTAK BiGG Fonu'nun payı, şirketin sermaye yapısına girmiş bir ortaklık payıdır; pay devri ve çıkış koşulları Pay Sahipliği Sözleşmesi'nde düzenlenir. Kesin şartlar için sözleşme metninin ve güncel çağrı duyurusunun incelenmesi gerekir."}},{"@type":"Question","name":"Aşama 3 (Tohum Yatırımı) için ayrıca başvurmak mı gerekiyor?","acceptedAnswer":{"@type":"Answer","text":"Evet. Aşama 2 yatırımını almış ve büyüme gösteren şirketler, ayrı bir değerlendirme süreciyle Aşama 3'e (Tohum Yatırımı) başvurabilir; burada %10'a kadar ek hisse karşılığında büyüme yatırımı söz konusudur."}}]}) }}
      />
    </BlogLayout>
  );
}
