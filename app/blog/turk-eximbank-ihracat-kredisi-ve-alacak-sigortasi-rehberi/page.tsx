  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Türk Eximbank kredisi almak için ihracatçı birliğine üye olmak şart mı?","acceptedAnswer":{"@type":"Answer","text":"Eximbank ürününe özgü bir üyelik şartı yok, ancak Türkiye'de yasal olarak ihracat yapabilmek için TİM'e bağlı 61 ihracatçı birliğinden en az birine üye olmak gerekiyor. Bu üyelik tamamlandıktan sonra Eximbank ürünlerine başvuru yapılabiliyor."}},{"@type":"Question","name":"KOBİ'ler Eximbank kredilerinden yararlanabiliyor mu, büyük ihracatçılardan farkı var mı?","acceptedAnswer":{"@type":"Answer","text":"Evet, Sevk Öncesi İhracat Kredisi ve İhracata Hazırlık Kredisi gibi başlıca kısa vadeli ürünlerde ayrı bir KOBİ hesaplama esası uygulanıyor. Kredi limiti her koşulda firma bazlı belirlense de KOBİ statüsündeki firmalar başvuru sürecine dahil ediliyor."}},{"@type":"Question","name":"Alacak sigortası olmadan ihracat yapabilir miyim, sigorta zorunlu mu?","acceptedAnswer":{"@type":"Answer","text":"Alacak sigortası yasal bir zorunluluk değil, isteğe bağlı bir risk yönetim aracıdır. Özellikle yeni bir pazarda, yeni bir alıcıyla ve vadeli satış koşullarında çalışırken tahsilat riskini azaltmak isteyen ihracatçılar tercih ediyor."}},{"@type":"Question","name":"Eximbank kredisi ile Ticaret Bakanlığı ihracat desteği aynı anda kullanılabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet, ikisi farklı mekanizmalardır ve birbirini dışlamaz. Ticaret Bakanlığı'nın geri ödemesiz destekleri belirli harcama kalemlerini (fuar, pazara giriş, e-ihracat gibi) karşılarken, Eximbank'ın kredileri nakit ihtiyacını, alacak sigortası ise tahsilat riskini kapsar. Bir firma her üç araçtan aynı anda, farklı ihtiyaçlar için yararlanabilir."}},{"@type":"Question","name":"Yeni kurulan bir ihracatçı firma daha ilk yılında Eximbank kredisi kullanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Prensip olarak mümkün, ancak kredi limiti bankanın yapacağı firma analizine (mali tablolar, ihracat performansı, teminat kapasitesi) göre belirlendiği için yeni kurulan bir firmanın limiti düşük çıkabilir veya teminat mektubu/İGE kefaleti şartı daha belirleyici hâle gelebilir. Somut durum başvuru anında bankanın değerlendirmesine bağlıdır."}},{"@type":"Question","name":"Alacak sigortasının primi ne kadar, sabit bir oran var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır, sabit bir prim oranı yok. Prim; ihracatın vadesine, ödeme şekline, alıcının bulunduğu ülkenin risk sınıfına ve alıcının kamu/özel niteliğine göre işlem bazında hesaplanıyor. Poliçe tanzim ücreti (1.500 TL) ve alıcı limiti analiz ücreti (2.500 TL) ise sabit kalemler."}}]}) }}
      />
    </BlogLayout>
  );
}
