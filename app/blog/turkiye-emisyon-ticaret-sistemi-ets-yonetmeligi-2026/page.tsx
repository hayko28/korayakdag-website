  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Türkiye Emisyon Ticaret Sistemi Yönetmeliği ne zaman yürürlüğe girdi?","acceptedAnswer":{"@type":"Answer","text":"Yönetmelik, 27 Ağustos 2026 tarihli ve 33353 sayılı Resmî Gazete'de yayımlandı. Dayanağı, 9 Temmuz 2025 tarihli ve 32951 sayılı Resmî Gazete'de yayımlanan 7552 sayılı İklim Kanunu'dur."}},{"@type":"Question","name":"Şirketim ETS kapsamında mı, nasıl anlarım?","acceptedAnswer":{"@type":"Answer","text":"İki koşulun birlikte sağlanması gerekir: tesisinizin faaliyetinin yönetmeliğin Ek-1 listesindeki faaliyetlerden biri olması ve yıllık sera gazı salım kapasitesinin 50.000 ton CO₂ eşdeğerini aşması. Pilot dönemde kapsam ağırlıklı olarak SKDM sektörleriyle sınırlı tutuluyor. Sınırda kalan tesislerde değerlendirmenin kapasite hesabı üzerinden teknik olarak yapılması gerekir."}},{"@type":"Question","name":"Pilot dönemde tahsisat için ödeme yapacak mıyım?","acceptedAnswer":{"@type":"Answer","text":"2026-2027 pilot döneminde tahsisatların kıyas yöntemine göre %100 ücretsiz dağıtılması öngörülüyor; yani doğrudan bir tahsisat satın alma maliyeti beklenmiyor. Ancak izleme, raporlama, doğrulama ve sisteme katılıma ilişkin operasyonel maliyetler bu dönemde de doğar."}},{"@type":"Question","name":"Sera gazı emisyon izni almazsam ne olur?","acceptedAnswer":{"@type":"Answer","text":"Doğrudan sera gazı emisyonuna neden olan ve kapsama giren işletmeler için sera gazı emisyon izni zorunludur; izinsiz faaliyet idari para cezası yaptırımına tabidir. Tahsisat teslim yükümlülüğünü üst üste yerine getirmeyen işletmelerin mevcut izinlerinin iptali de gündeme gelebilir."}},{"@type":"Question","name":"Elimde fazla tahsisat kalırsa ne yapabilirim?","acceptedAnswer":{"@type":"Answer","text":"Sistem, esneklik mekanizmaları içeriyor: fazla tahsisat piyasada satılabilir ya da ilgili kurallar çerçevesinde sonraki döneme aktarılabilir (bankalama). Emisyonunu erken azaltan işletme için bu, karbon yönetiminin bir maliyet kaleminden gelir kalemine dönüşebileceği anlamına gelir."}},{"@type":"Question","name":"ETS ile TSRS sürdürülebilirlik raporlaması aynı şey mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. TSRS, finansal raporlamaya paralel bir sürdürülebilirlik bilgi açıklama çerçevesidir; ETS ise emisyona doğrudan fiyat ve teslim yükümlülüğü getiren bir piyasa mekanizmasıdır. Ancak ikisinin de temeli aynı veridir: doğru ölçülmüş ve doğrulanabilir sera gazı emisyonu. Bu nedenle iki sürecin tek bir veri altyapısı üzerinden kurgulanması hem maliyeti hem de tutarsızlık riskini düşürür."}}]}) }}
      />
    </BlogLayout>
  );
}
