  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Yabancı bir kişi Türkiye'de %100 kendi şirketini kurabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. 4875 sayılı Doğrudan Yabancı Yatırımlar Kanunu kapsamında yabancı gerçek veya tüzel kişiler, Türk ortağa ihtiyaç duymadan şirketin %100'üne sahip olabilir ve yönetiminde doğrudan görev alabilir."}},{"@type":"Question","name":"Şirket kurmak için Türkiye'de fiziken bulunmam gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Vergi numarası alınması, MERSİS kaydı, ana sözleşmenin hazırlanması ve ticaret sicili tescili, apostilli vekâletname ile bir vekil aracılığıyla uzaktan yürütülebilir. Fiziken bulunma ihtiyacı genellikle yalnızca banka hesabı açılışında ortaya çıkar."}},{"@type":"Question","name":"Limited Şirket mi Anonim Şirket mi daha uygun?","acceptedAnswer":{"@type":"Answer","text":"KOBİ ölçekli ticaret, hizmet ve danışmanlık faaliyetleri için düşük sermaye şartı ve esnek yapısı nedeniyle Limited Şirket genellikle tercih edilir. Büyük ölçekli üretim yatırımları, yatırım teşvik belgesi başvuruları veya çok ortaklı kurumsal yapılar için Anonim Şirket daha uygun olabilir."}},{"@type":"Question","name":"Şirket kurmak otomatik olarak oturma izni sağlar mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Şirket kurmak ile ikamet/çalışma izni almak ayrı süreçlerdir. Aktif faaliyet gösteren bir şirkete sahip olmak, ikamet izni başvurusu için güçlü bir dayanak oluşturur; ancak başvuru İl Göç İdaresi tarafından ayrıca değerlendirilir."}},{"@type":"Question","name":"Yabancı sermayeli şirketler KOSGEB ve Ticaret Bakanlığı desteklerinden yararlanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de kurulmuş ve ilgili kritere (KOBİ tanımı, ihracat faaliyeti vb.) uyan şirketler, ortaklık yapısındaki yabancı sermaye oranından bağımsız olarak destek programlarına başvurabilir. Bazı destek kalemlerinde istihdam edilecek personelin uyruğuna ilişkin özel şartlar bulunabilir; bu şartlar destek bazında değerlendirilmelidir."}},{"@type":"Question","name":"Serbest bölgede şirket kurmak, yurt içinde kurmaktan daha mı avantajlı?","acceptedAnswer":{"@type":"Answer","text":"Bu, faaliyet konusuna bağlıdır. İhracat ağırlıklı üretim, depolama veya lojistik faaliyetlerinde serbest bölge; gümrük ve KDV muafiyetleri ile ihracat kazancı vergi istisnası sayesinde belirgin bir maliyet avantajı sağlar. Yerel pazara doğrudan satış yapacak şirketler için ise klasik yurt içi şirket yapısı genellikle daha uygundur."}},{"@type":"Question","name":"Kuruluş ve yıllık işletme maliyeti ne kadar tutar?","acceptedAnswer":{"@type":"Answer","text":"Kuruluş işlem bedeli, şirket türü ve sermaye tutarına göre gösterge olarak Limited Şirket'te 50.000-80.000 TL, Anonim Şirket'te 65.000-100.000 TL aralığında değişebilir. Buna ek olarak aylık muhasebe hizmeti, işlem hacmi ve çalışan sayısına göre ayrıca fiyatlandırılır; net rakam için iletişime geçmenizi öneririz."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Belgeler eksiksiz hazırlandığında MERSİS ön kaydından ticaret sicili tesciline kadar süreç genellikle 1-2 hafta içinde tamamlanır. Banka hesabı açılışı ve operasyonel hazırlıklar dahil edildiğinde toplam süreç 3-4 haftaya kadar uzayabilir."}},{"@type":"Question","name":"Kuruluş sonrasında hangi düzenli yükümlülükler doğar?","acceptedAnswer":{"@type":"Answer","text":"Aylık KDV beyannamesi, üçer aylık geçici vergi beyannamesi, yıllık kurumlar vergisi beyannamesi, e-Defter/e-Fatura kayıtları ve varsa çalışan bordrosu düzenli olarak takip edilmesi gereken temel yükümlülüklerdir. Bu süreçlerin tamamını kuruluş sonrasında biz üstleniyoruz; ayrıca yerel bir mali müşavir aramanıza gerek kalmıyor."}}]}) }}
      />
    </BlogLayout>
  );
}
