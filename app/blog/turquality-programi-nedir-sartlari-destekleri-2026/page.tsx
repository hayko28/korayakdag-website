  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Turquality bir hibe midir?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Turquality, şirketin markalaşma sürecinde yapacağı tescil, danışmanlık, istihdam, tanıtım, fuar ve mağaza/ showroom gibi harcamaların belirli bir oranının (%50'den başlayıp hedef ülke/sektör bonusuyla %75'e kadar çıkan) geri ödemesiz olarak karşılandığı bir destek mekanizmasıdır; doğrudan nakit hibe değildir."}},{"@type":"Question","name":"Marka Destek Programı ile Turquality arasındaki en önemli fark nedir?","acceptedAnswer":{"@type":"Answer","text":"Aynı başvuru sürecinden geçen firmalar, ön inceleme puanına göre ayrışır: 50-80 puan alan firmalar Marka Destek Programı'na (4 yıl sabit süreli), 80-100 puan alan firmalar ise Turquality Destek Programı'na (her hedef pazar için 5 yıl, daha yüksek üst limit) dahil edilir."}},{"@type":"Question","name":"Başvuru için minimum ihracat tutarı ne kadar?","acceptedAnswer":{"@type":"Answer","text":"Kural olarak son 3 yıllık ortalama ihracatın en az 3.000.000 ABD Doları olması gerekir. Ancak son 1 yılda en az 10.000.000 ABD Doları ihracat yapan şirketlerde bu şart ve bazı tescil süresi şartları aranmaz."}},{"@type":"Question","name":"Başvuru ücretli midir?","acceptedAnswer":{"@type":"Answer","text":"Başvurunun kendisi resmî bir harca tabi değildir, ancak görevlendirilen yönetim danışmanlığı firmasının yapacağı ön inceleme çalışması için başvuru sahibi şirket, belirlenen bir ön inceleme ücretini 1 ay içinde ödemekle yükümlüdür."}},{"@type":"Question","name":"Başvurum reddedilirse ne olur?","acceptedAnswer":{"@type":"Answer","text":"Ön inceleme raporunda 50 puanın altında kalan başvurular reddedilir. Reddedilen şirketler, 6 ay sonra yeniden başvuru yapabilir; bu süre genellikle eksik kalan kurumsallaşma, tescil veya stratejik planlama unsurlarını tamamlamak için kullanılmalıdır."}},{"@type":"Question","name":"Sadece üreticiler mi başvurabilir?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Mal ihracatı yapan üretici firmaların yanı sıra gastronomi, yazılım/bilişim (e-Turquality), lojistik, sağlık turizmi ve eğitim gibi döviz kazandırıcı hizmet sektörlerindeki firmalar da ayrı bir hizmet ihracatı programı çerçevesinde Turquality'den yararlanabilir."}},{"@type":"Question","name":"Satın alınan bir marka Turquality desteğinden yararlanabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Program, organik olarak geliştirilmiş markaları desteklemeyi amaçladığından, başka bir şirketten satın alınan yabancı markalar destek kapsamı dışında tutulur."}},{"@type":"Question","name":"Turquality başvurusunu danışmanlık almadan tek başıma yürütebilir miyim?","acceptedAnswer":{"@type":"Answer","text":"Teknik olarak mümkündür; ancak marka tescil stratejisinin doğru sıralanması, ihracat verilerinin doğru konsolide edilmesi, kurumsal altyapı belgelerinin hazırlanması ve stratejik iş planının ön inceleme puanını yükseltecek şekilde kurgulanması, sürecin en başından itibaren doğru yönetilmesini gerektirir. Küçük bir eksiklik, hem puanı düşürüp Marka Programı'nda kalmanıza hem de başvurunun doğrudan reddedilmesine yol açabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
