  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Savaş koşulları nedeniyle Ukrayna'da şirket kurmak güvenli mi?","acceptedAnswer":{"@type":"Answer","text":"Ukrayna'da şirket kuruluşu hukuken mümkün ve devlet sistemi işlevini sürdürüyor; ancak bölgesel güvenlik durumu, altyapı riskleri ve mevzuat dönemsel olarak değişebiliyor. Yatırım kararı öncesinde güncel resmi kaynaklardan ve profesyonel danışmanlıktan teyit almak, riskleri yönetilebilir seviyede tutmanın en doğru yoludur."}},{"@type":"Question","name":"Ukrayna'da şirket kurmak için ülkede bulunmak gerekir mi?","acceptedAnswer":{"@type":"Answer","text":"Hayır. Kuruluş başvurusu noter onaylı, apostilli vekâletname ile Türkiye'den yürütülebilir ve tescil büyük ölçüde elektronik sistem üzerinden tamamlanır. Ancak kurumsal banka hesabı açılışı için bazı bankalar yetkili imza sahibinin fiziken bulunmasını talep edebilir."}},{"@type":"Question","name":"Yabancı bir kişi Ukrayna şirketinin müdürü olabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Yabancı bir kişinin resmi müdür olarak atanabilmesi için ilke olarak çalışma izni gereklidir. Uygulamada geçici olarak mukim bir müdür ataması veya vekâletname ile yetkilendirme yaygın çözüm yollarıdır; bu konu kuruluş öncesinde netleştirilmelidir."}},{"@type":"Question","name":"TOV kurmak için asgari sermaye şartı var mı?","acceptedAnswer":{"@type":"Answer","text":"Hayır. 2018 tarihli kanun ile TOV kuruluşunda yasal asgari sermaye şartı kaldırıldı; kayıtlı sermaye sembolik bir tutarda belirlenebilir. Bankacılık, sigortacılık gibi düzenlemeye tabi sektörlerde ise ilgili otoritenin belirlediği çok daha yüksek sermaye eşikleri uygulanır."}},{"@type":"Question","name":"Ukrayna'da şirketin %100'ü yabancıya ait olabilir mi?","acceptedAnswer":{"@type":"Answer","text":"Evet. Ukrayna mevzuatı yabancı gerçek veya tüzel kişilerin TOV'un tamamına sahip olmasına izin verir; yerli ortak zorunluluğu bulunmaz. Rusya ve bazı durumlarda Belarus ile bağlantılı kişilere yönelik yaptırım kapsamındaki kısıtlamalar ise ayrı bir değerlendirme konusudur."}},{"@type":"Question","name":"Kuruluş süreci ne kadar sürer?","acceptedAnswer":{"@type":"Answer","text":"Belgeler eksiksiz olduğunda ve otomatik doğrulama şartları sağlandığında TOV tescili dakikalar içinde tamamlanabilir; ek inceleme gerektiren veya çok ortaklı yapılarda süreç birkaç iş gününe uzayabilir. Banka hesabı açılışı dahil edildiğinde toplam süreç 1-2 haftaya kadar çıkabilir."}}]}) }}
      />
    </BlogLayout>
  );
}
