  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Vergi planlaması nedir, vergiden kaçınmaktan farkı ne?","acceptedAnswer":{"@type":"Answer","text":"Vergi planlaması, kanunun tanıdığı istisna, indirim ve teşviklerin mevzuata tam uyumlu ve belgeli şekilde kullanılmasıdır. Riskli veya belgesiz yapılar kurarak vergi matrahını düşürmeye çalışmak ise vergiden kaçınma sayılır ve denetimde ciddi cezai risk taşır."}},{"@type":"Question","name":"Transfer fiyatlandırması raporu kimler için zorunlu?","acceptedAnswer":{"@type":"Answer","text":"İlişkili kişilerle (grup şirketleri, ortaklar, yurt dışı iştirakler) işlemi bulunan tüm kurumlar vergisi mükellefleri, en azından Transfer Fiyatlandırması Formu'nu doldurmakla yükümlüdür. Büyük Mükellefler Vergi Dairesi mükellefleri yurt içi ve yurt dışı işlemleri için, diğer kurumlar ise yurt dışı ilişkili işlemleri için Yıllık Transfer Fiyatlandırması Raporu hazırlar. Aktif toplamı ve net satışları 500 milyon TL'yi aşan çok uluslu grup üyeleri ayrıca Genel Rapor (Master File) hazırlar."}},{"@type":"Question","name":"Yurt dışından gelir elde eden bir şirket Türkiye'de nasıl vergilendirilir?","acceptedAnswer":{"@type":"Answer","text":"Türkiye'de tam mükellef bir kurum, dünya çapındaki tüm kazancı üzerinden Türkiye'de kurumlar vergisi öder. Çifte vergilendirme, ilgili ülkeyle imzalanmış bir çifte vergilendirmeyi önleme anlaşması varsa bu anlaşma hükümlerine göre, yurt dışı iştirak kazançlarında ise KVK 5/1-b maddesindeki şartların (en az %10 sermaye payı, 1 yıl elde tutma, en az %15 vergi yükü, süresinde transfer) birlikte sağlanması halinde istisna yoluyla önlenir."}},{"@type":"Question","name":"2026'da e-Fatura geçiş haddi kaç TL?","acceptedAnswer":{"@type":"Answer","text":"Genel had, ilgili hesap döneminde 3 milyon TL ve üzeri brüt satış hasılatıdır; bu hadi aşan mükellefler takip eden yılın 1 Temmuz'u itibarıyla e-Fatura'ya geçmek zorundadır. E-ticaret, gayrimenkul ve motorlu araç ticaretinde had 500.000 TL'ye düşer. Güncel had her yıl Vergi Usul Kanunu Genel Tebliği ile yeniden belirlenir."}},{"@type":"Question","name":"KOBİ'ler için uluslararası vergi danışmanlığı ne zaman gerekli hale gelir?","acceptedAnswer":{"@type":"Answer","text":"Şirket ihracat yapmaya, yurt dışında ortaklık/şube kurmaya veya yurt dışındaki bir grup şirketiyle işlem yapmaya başladığı andan itibaren transfer fiyatlandırması ve çifte vergilendirme riski doğar. Bu nedenle yurt dışı ilişki kurulmadan önce danışmanlık alınması, sonradan düzeltme yapmaktan çok daha az maliyetlidir."}}]}) }}
      />
    </BlogLayout>
  );
}
