...
export default function GuncelGelismelerPage() {
  ...
  const oneCikanGelismeler = gelismeler.slice(0, 3);
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="overflow-hidden bg-[#071A2F] px-6 pb-10 pt-12 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* Sağ görsel — en son gelişmeleri gösteren mini kart */}
            ...
            <div className="relative">
              ...
              <div className="relative rotate-1 rounded-2xl border border-white/10 bg-[#0A1E36] p-5 shadow-2xl">
                ...
                <div className="space-y-2.5">
                  {oneCikanGelismeler.map((item, i) => (
                    <div key={item.baslik} className="rounded-xl bg-white/5 px-3 py-2.5">
                      <div className="mb-1 flex items-center justify-between gap-2">
                        <span className="truncate text-[11px] font-bold text-emerald-300">
                          {item.kurum}
                        </span>
                        {i === 0 && (
                ...
                <div className="mt-4 flex items-center gap-1.5 text-[11px] text-gray-500">
                  ...
                  Her gün takip edilip güncelleniyor
                </div>
              </div>
            </div>
          </div>
