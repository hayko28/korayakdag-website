...
export const LINKEDIN_DRAFTS: LinkedInDraft[] = [
  ...
  },
  {
    tarih: "2026-08-14",
    icerik:
      "\"On dakikalık hızlı bir görüşme yapalım\" cümlesini duyduğumda artık takvimimde bir saat blokluyorum.\n\nİstatistiğim şu: son bir yılda katıldığım \"on dakikalık\" görüşmelerin tam olarak sıfırı on dakikada bitti. Ortalama süre 47 dakika. En uzunu, bir yatırım teşviki başvurusunu konuştuğumuz bir görüşmeydi — \"sadece iki soru soracağım\" diye başladı, iki saat sonra üçümüz de kahve söylemiştik.\n\nAma ilginç olan şu: o \"hızlı\" görüşmelerin çoğu, asıl kararın verildiği yer oldu. Resmi toplantıda kimse konuşmuyor, telefon kapanmadan hemen önceki o \"bu arada bir şey soracaktım\" cümlesinde gerçek dertler ortaya çıkıyor.\n\nSiz de takviminizde \"hızlı görüşme\" diye ayırdığınız o 15 dakikalık slotları biliyorsunuzdur — gerçekte ne kadar sürüyor?\n\nDanışmanlıkta öğrendiğim diğer derslerim burada: https://korayakdag.com/makaleler/danismanlik-yaparken-ogrendigim-5-sey\n\n#İşHayatı #ToplantıKültürü #Danışmanlık #Girişimcilik #Kariyer #İşDünyası #Verimlilik #ÇalışmaHayatı #Yönetim #StratejikDanışmanlık",
    ...
    gorselUrl:
      "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
];
